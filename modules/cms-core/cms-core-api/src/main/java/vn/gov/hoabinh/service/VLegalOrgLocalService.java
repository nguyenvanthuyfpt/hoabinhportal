...
/**
 * Provides the local service interface for VLegalOrg. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see VLegalOrgLocalServiceUtil
...
public interface VLegalOrgLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VLegalOrgLocalServiceUtil} to access the v legal org local service. Add custom service methods to {@link vn.gov.hoabinh.service.impl.VLegalOrgLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VLegalOrg> getAllOrg()
		throws PortalException, SystemException, RemoteException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VLegalOrg> getAllOrgByS_L(long groupId, boolean status,
		java.lang.String language)
		throws PortalException, SystemException, RemoteException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VLegalOrg> getAllOrgByS_Rss(long groupId, boolean status,
		boolean rssable)
		throws PortalException, SystemException, RemoteException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VLegalOrg> getOrgByG_L(long groupId, java.lang.String language)
		throws PortalException, SystemException, RemoteException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VLegalOrg> getOrgByG_L_P(long groupId,
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VLegalOrg> getOrgByG_L_P_S(long groupId,
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VLegalOrg> getOrgByGroupId(long groupId)
	...
	*/
	...
	public VLegalOrg addOrg(long groupId, java.lang.String name,
		java.lang.String description, java.lang.String language,
		boolean rssable, boolean status, java.lang.String parentId,
	...
	*/
	public VLegalOrg createVLegalOrg(java.lang.String orgId);
	...
	*/
	...
	public VLegalOrg deleteVLegalOrg(java.lang.String orgId)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VLegalOrg fetchVLegalOrg(java.lang.String orgId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VLegalOrg getOrg(java.lang.String orgId)
		throws PortalException, SystemException, RemoteException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VLegalOrg getOrg(long groupId, java.lang.String orgId)
		throws PortalException, SystemException, RemoteException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VLegalOrg getVLegalOrg(java.lang.String orgId)
		throws PortalException;

	public VLegalOrg updateOrg(long groupId, java.lang.String orgId,
		java.lang.String name, java.lang.String description,
		java.lang.String language, boolean rssable, boolean status,
		java.lang.String parentId, int position)
		throws PortalException, SystemException, RemoteException;

	public VLegalOrg updateOrg(VLegalOrg vOrg)
		throws PortalException, SystemException, RemoteException;
