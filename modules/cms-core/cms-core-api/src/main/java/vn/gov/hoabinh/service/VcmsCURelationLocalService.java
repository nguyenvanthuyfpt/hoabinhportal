...
/**
 * Provides the local service interface for VcmsCURelation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see VcmsCURelationLocalServiceUtil
...
public interface VcmsCURelationLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VcmsCURelationLocalServiceUtil} to access the vcms c u relation local service. Add custom service methods to {@link vn.gov.hoabinh.service.impl.VcmsCURelationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
