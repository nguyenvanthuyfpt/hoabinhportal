...
/**
 * Provides the local service interface for LinkGroup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LinkGroupLocalServiceUtil
...
public interface LinkGroupLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LinkGroupLocalServiceUtil} to access the link group local service. Add custom service methods to {@link vn.gov.hoabinh.service.impl.LinkGroupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LinkGroup> getByGroupId(long groupId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LinkGroup> getLinkGroupByIds(java.lang.String[] linkGroupSel);
	...
	*/
	...
	public LinkGroup addLinkGroup(long groupId, long companyId, long plid,
		...
		long userId) throws PortalException, SystemException, RemoteException;
