...
/**
 * Provides the local service interface for VisitorTracker. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see VisitorTrackerLocalServiceUtil
...
public interface VisitorTrackerLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VisitorTrackerLocalServiceUtil} to access the visitor tracker local service. Add custom service methods to {@link vn.gov.hoabinh.service.impl.VisitorTrackerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	public DynamicQuery buildDynamicQuery(long companyId, long groupId,
	...
	*/
	...
	public int countVisitorByC_G(long companyId, long groupId)
		throws java.lang.Exception;

	public int countVisitorByDate(long companyId, long groupId, Date startDate,
		Date endDate) throws java.lang.Exception;
	...
	*/
	...
	public VisitorTracker addVisitor(long companyId, long groupId)
		throws java.lang.Exception;
