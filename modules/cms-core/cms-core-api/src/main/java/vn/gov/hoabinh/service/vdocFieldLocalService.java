...
/**
 * Provides the local service interface for vdocField. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see vdocFieldLocalServiceUtil
...
public interface vdocFieldLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link vdocFieldLocalServiceUtil} to access the vdoc field local service. Add custom service methods to {@link vn.gov.hoabinh.service.impl.vdocFieldLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<vdocField> getFieldByG_L(long groupId, java.lang.String language)
		throws PortalException, SystemException, RemoteException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<vdocField> getFieldByG_L(long groupId,
		java.lang.String language, int begin, int end)
		throws PortalException, SystemException, RemoteException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List getFieldByG_L_P(long groupId, java.lang.String language,
		java.lang.String parentId)
		throws PortalException, SystemException, RemoteException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<vdocField> getFieldByG_L_P(long groupId,
		java.lang.String language, java.lang.String parentId, int begin, int end)
		throws PortalException, SystemException, RemoteException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<vdocField> getFieldByParentId(java.lang.String parentId)
		throws PortalException, SystemException, RemoteException;
	...
	*/
	...
	public vdocField addField(long groupId, long userId,
	...
	*/
	public vdocField createvdocField(java.lang.String fieldId);
	...
	*/
	...
	public vdocField deletevdocField(java.lang.String fieldId)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public vdocField fetchvdocField(java.lang.String fieldId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public vdocField getField(java.lang.String fieldId)
		throws PortalException, SystemException, RemoteException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public vdocField getvdocField(java.lang.String fieldId)
		throws PortalException;

	public vdocField updateField(java.lang.String fieldId, long groupId,
		long userId, java.lang.String language, java.lang.String parentId,
		java.lang.String name, java.lang.String description,
		boolean statusField, int position, java.lang.String listparent,
		java.lang.String levels, ThemeDisplay themeDisplay)
		throws PortalException, SystemException, RemoteException;
	...
	*/
	...
	public void deleteField(java.lang.String fieldId, ThemeDisplay themeDisplay)
		throws PortalException, SystemException, RemoteException;
}