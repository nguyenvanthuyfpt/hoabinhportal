...
/**
 * Provides the local service interface for AdvType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AdvTypeLocalServiceUtil
...
public interface AdvTypeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AdvTypeLocalServiceUtil} to access the adv type local service. Add custom service methods to {@link vn.gov.hoabinh.service.impl.AdvTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AdvType> getTypeByG(long groupId)
		throws PortalException, SystemException, RemoteException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AdvType getType(long typeId)
		throws PortalException, SystemException, RemoteException;
