...
public class vdocDocumentSoap implements Serializable {
	public static vdocDocumentSoap toSoapModel(vdocDocument model) {
		...
		soapModel.setLevels(model.getLevels());
