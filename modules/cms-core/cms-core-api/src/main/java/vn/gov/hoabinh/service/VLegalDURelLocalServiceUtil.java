...
/**
 * Provides the local service utility for VLegalDURel. This utility wraps
 * {@link vn.gov.hoabinh.service.impl.VLegalDURelLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class VLegalDURelLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.gov.hoabinh.service.impl.VLegalDURelLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static int getVLegalDURelsCount() {
		return getService().getVLegalDURelsCount();
	}
	...
	*/
	public static java.util.List<vn.gov.hoabinh.model.VLegalDURel> getVLegalDURels(
		int start, int end) {
		return getService().getVLegalDURels(start, end);
	}
	...
	*/
	...
	public static vn.gov.hoabinh.model.VLegalDURel addRelation(
	...
	*/
	public static vn.gov.hoabinh.model.VLegalDURel addVLegalDURel(
		vn.gov.hoabinh.model.VLegalDURel vLegalDURel) {
		return getService().addVLegalDURel(vLegalDURel);
	}
	...
	*/
	public static vn.gov.hoabinh.model.VLegalDURel createVLegalDURel(
		vn.gov.hoabinh.service.persistence.VLegalDURelPK vLegalDURelPK) {
		return getService().createVLegalDURel(vLegalDURelPK);
	}
	...
	*/
	public static vn.gov.hoabinh.model.VLegalDURel deleteVLegalDURel(
		vn.gov.hoabinh.model.VLegalDURel vLegalDURel) {
		return getService().deleteVLegalDURel(vLegalDURel);
	}
	...
	*/
	public static vn.gov.hoabinh.model.VLegalDURel deleteVLegalDURel(
		vn.gov.hoabinh.service.persistence.VLegalDURelPK vLegalDURelPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteVLegalDURel(vLegalDURelPK);
	}

	public static vn.gov.hoabinh.model.VLegalDURel fetchVLegalDURel(
		vn.gov.hoabinh.service.persistence.VLegalDURelPK vLegalDURelPK) {
		return getService().fetchVLegalDURel(vLegalDURelPK);
	}

	public static vn.gov.hoabinh.model.VLegalDURel getByUserId(long userid)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException,
			java.rmi.RemoteException {
	...
	* @throws PortalException if a v legal d u rel with the primary key could not be found
	*/
	public static vn.gov.hoabinh.model.VLegalDURel getVLegalDURel(
		vn.gov.hoabinh.service.persistence.VLegalDURelPK vLegalDURelPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getVLegalDURel(vLegalDURelPK);
	}
	...
	*/
	public static vn.gov.hoabinh.model.VLegalDURel updateVLegalDURel(
		vn.gov.hoabinh.model.VLegalDURel vLegalDURel) {
		return getService().updateVLegalDURel(vLegalDURel);
	}
	...
	public static VLegalDURelLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<VLegalDURelLocalService, VLegalDURelLocalService> _serviceTracker =
		ServiceTrackerFactory.open(VLegalDURelLocalService.class);
}