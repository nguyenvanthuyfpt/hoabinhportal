...
/**
 * Provides the local service interface for VLegalDFRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see VLegalDFRelLocalServiceUtil
...
public interface VLegalDFRelLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VLegalDFRelLocalServiceUtil} to access the v legal d f rel local service. Add custom service methods to {@link vn.gov.hoabinh.service.impl.VLegalDFRelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public VLegalDFRel addRelation(java.lang.String docId,
