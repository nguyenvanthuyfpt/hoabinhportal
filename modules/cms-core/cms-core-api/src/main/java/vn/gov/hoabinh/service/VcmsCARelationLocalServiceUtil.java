...
/**
 * Provides the local service utility for VcmsCARelation. This utility wraps
 * {@link vn.gov.hoabinh.service.impl.VcmsCARelationLocalServiceImpl} and is the
...
public class VcmsCARelationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.gov.hoabinh.service.impl.VcmsCARelationLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static java.util.List<vn.gov.hoabinh.model.VcmsCARelation> getRelationsByArticle(
	...
	public static java.util.List<vn.gov.hoabinh.model.VcmsCARelation> getRelationsByCategory(
	...
	*/
	public static java.util.List<vn.gov.hoabinh.model.VcmsCARelation> getVcmsCARelations(
		int start, int end) {
	...
	*/
	...
	public static vn.gov.hoabinh.model.VcmsCARelation addRelation(
	...
	*/
	public static vn.gov.hoabinh.model.VcmsCARelation addVcmsCARelation(
	...
	*/
	public static vn.gov.hoabinh.model.VcmsCARelation createVcmsCARelation(
	...
	*/
	public static vn.gov.hoabinh.model.VcmsCARelation deleteVcmsCARelation(
		vn.gov.hoabinh.model.VcmsCARelation vcmsCARelation) {
		return getService().deleteVcmsCARelation(vcmsCARelation);
	}
	...
	*/
	public static vn.gov.hoabinh.model.VcmsCARelation deleteVcmsCARelation(
		vn.gov.hoabinh.service.persistence.VcmsCARelationPK vcmsCARelationPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteVcmsCARelation(vcmsCARelationPK);
	}

	public static vn.gov.hoabinh.model.VcmsCARelation fetchVcmsCARelation(
		vn.gov.hoabinh.service.persistence.VcmsCARelationPK vcmsCARelationPK) {
		return getService().fetchVcmsCARelation(vcmsCARelationPK);
	}

	public static vn.gov.hoabinh.model.VcmsCARelation findRelationsByArticle(
		java.lang.String articleId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException,
			java.rmi.RemoteException {
	...
	* @throws PortalException if a vcms c a relation with the primary key could not be found
	*/
	public static vn.gov.hoabinh.model.VcmsCARelation getVcmsCARelation(
		vn.gov.hoabinh.service.persistence.VcmsCARelationPK vcmsCARelationPK)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static vn.gov.hoabinh.model.VcmsCARelation updateVcmsCARelation(
		vn.gov.hoabinh.model.VcmsCARelation vcmsCARelation) {
	...
	private static ServiceTracker<VcmsCARelationLocalService, VcmsCARelationLocalService> _serviceTracker =
		ServiceTrackerFactory.open(VcmsCARelationLocalService.class);
}