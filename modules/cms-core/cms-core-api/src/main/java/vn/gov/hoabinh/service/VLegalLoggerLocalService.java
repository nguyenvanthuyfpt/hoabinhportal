...
/**
 * Provides the local service interface for VLegalLogger. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see VLegalLoggerLocalServiceUtil
...
public interface VLegalLoggerLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VLegalLoggerLocalServiceUtil} to access the v legal logger local service. Add custom service methods to {@link vn.gov.hoabinh.service.impl.VLegalLoggerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List findLogs(int begin, int end)
		throws PortalException, SystemException, RemoteException;
	...
	*/
	public VLegalLogger createVLegalLogger(java.lang.String loggerId);
	...
	*/
	...
	public VLegalLogger deleteVLegalLogger(java.lang.String loggerId)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VLegalLogger fetchVLegalLogger(java.lang.String loggerId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VLegalLogger getVLegalLogger(java.lang.String loggerId)
		throws PortalException;

	public VLegalLogger log(long groupId, java.lang.String content)
		throws PortalException, SystemException, RemoteException;
