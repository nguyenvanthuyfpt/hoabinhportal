...
/**
 * Provides the local service interface for VcmsType. Methods of this
...
public interface VcmsTypeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VcmsTypeLocalServiceUtil} to access the vcms type local service. Add custom service methods to {@link vn.gov.hoabinh.service.impl.VcmsTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VcmsType> getTypesByS_L(long groupId, java.lang.String language)
		throws PortalException, SystemException, RemoteException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List getTypesByS_L(long groupId, java.lang.String language,
		int start, int end)
		throws PortalException, SystemException, RemoteException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VcmsType getType(long typeId)
		throws PortalException, SystemException, RemoteException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VcmsType getTypeByS_C(long groupId, java.lang.String code)
		throws PortalException, SystemException, RemoteException;
	...
	*/
	...
	public VcmsType updateType(long typeId, long groupId, long companyId,
		java.lang.String code, java.lang.String name,
		java.lang.String description, java.lang.String language)
		throws PortalException, SystemException, RemoteException;
