...
/**
 * Provides the local service interface for FAQAnswer. Methods of this
...
public interface FAQAnswerLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FAQAnswerLocalServiceUtil} to access the f a q answer local service. Add custom service methods to {@link vn.gov.hoabinh.service.impl.FAQAnswerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	public DynamicQuery buildAnswerDQ(long groupId, java.lang.String language,
		boolean isStatus, boolean approved, long questionId, boolean isCount);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FAQAnswer> getAnswerByG_L(java.lang.String language)
		throws PortalException, SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FAQAnswer> getAnswerByG_L(java.lang.String language, int start,
		int end) throws PortalException, SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FAQAnswer> getAnswerByParam(long groupId,
		java.lang.String language, boolean isStatus, boolean approved,
		long questionId, boolean isCount, int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FAQAnswer> getByApprove(boolean approved)
		throws PortalException, SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FAQAnswer> getByApprove(boolean approved, int begin, int end)
		throws PortalException, SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FAQAnswer> getByQ_A(long questionId, boolean approved)
		throws PortalException, SystemException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FAQAnswer> getByQuestion(long questionId)
		throws PortalException, SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FAQAnswer> getByQuestion(long questionId, int begin, int end)
		throws PortalException, SystemException;
	...
	*/
	...
	public FAQAnswer addAnswer(java.lang.String language, long questionId,
	...
	*/
	...
	public FAQAnswer approveAnswer(long answerId,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FAQAnswer getAnswer(long answerId)
		throws PortalException, SystemException;
	...
	*/
	...
	public FAQAnswer unapproveAnswer(long answerId,
		java.lang.String approvedByUser)
		throws PortalException, SystemException;

	public FAQAnswer updateAnswer(long answerId, java.lang.String content,
		int answerOrder, java.lang.String language, boolean isApproved,
		java.lang.String answerByUser, java.lang.String approvedByUser,
