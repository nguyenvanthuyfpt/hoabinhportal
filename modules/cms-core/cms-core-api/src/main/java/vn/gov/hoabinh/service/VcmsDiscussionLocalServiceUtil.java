...
/**
 * Provides the local service utility for VcmsDiscussion. This utility wraps
 * {@link vn.gov.hoabinh.service.impl.VcmsDiscussionLocalServiceImpl} and is the
...
public class VcmsDiscussionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.gov.hoabinh.service.impl.VcmsDiscussionLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static java.util.List<vn.gov.hoabinh.model.VcmsDiscussion> getDiscussions(
	...
	public static java.util.List<vn.gov.hoabinh.model.VcmsDiscussion> getDiscussionsByA_P_L_A(
	...
	public static java.util.List<vn.gov.hoabinh.model.VcmsDiscussion> getDiscussionsByP_L(
	...
	public static java.util.List<vn.gov.hoabinh.model.VcmsDiscussion> getDiscussionsByP_L_A(
	...
	*/
	public static java.util.List<vn.gov.hoabinh.model.VcmsDiscussion> getVcmsDiscussions(
		int start, int end) {
	...
	*/
	...
	public static vn.gov.hoabinh.model.VcmsDiscussion addDiscussion(
	...
	*/
	public static vn.gov.hoabinh.model.VcmsDiscussion addVcmsDiscussion(
	...
	*/
	public static vn.gov.hoabinh.model.VcmsDiscussion createVcmsDiscussion(
	...
	*/
	public static vn.gov.hoabinh.model.VcmsDiscussion deleteVcmsDiscussion(
		java.lang.String discussionId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteVcmsDiscussion(discussionId);
	}
	...
	*/
	public static vn.gov.hoabinh.model.VcmsDiscussion deleteVcmsDiscussion(
		vn.gov.hoabinh.model.VcmsDiscussion vcmsDiscussion) {
		return getService().deleteVcmsDiscussion(vcmsDiscussion);
	}

	public static vn.gov.hoabinh.model.VcmsDiscussion fetchVcmsDiscussion(
		java.lang.String discussionId) {
		return getService().fetchVcmsDiscussion(discussionId);
	}

	public static vn.gov.hoabinh.model.VcmsDiscussion getDiscussion(
		java.lang.String discussionId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException,
			java.rmi.RemoteException {
	...
	* @throws PortalException if a vcms discussion with the primary key could not be found
	*/
	public static vn.gov.hoabinh.model.VcmsDiscussion getVcmsDiscussion(
		java.lang.String discussionId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getVcmsDiscussion(discussionId);
	}

	public static vn.gov.hoabinh.model.VcmsDiscussion updateDiscussion(
	...
	*/
	public static vn.gov.hoabinh.model.VcmsDiscussion updateVcmsDiscussion(
		vn.gov.hoabinh.model.VcmsDiscussion vcmsDiscussion) {
	...
	private static ServiceTracker<VcmsDiscussionLocalService, VcmsDiscussionLocalService> _serviceTracker =
		ServiceTrackerFactory.open(VcmsDiscussionLocalService.class);
}