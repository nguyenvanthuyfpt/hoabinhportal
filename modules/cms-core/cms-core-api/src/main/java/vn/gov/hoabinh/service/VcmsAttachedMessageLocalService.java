...
/**
 * Provides the local service interface for VcmsAttachedMessage. Methods of this
...
public interface VcmsAttachedMessageLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VcmsAttachedMessageLocalServiceUtil} to access the vcms attached message local service. Add custom service methods to {@link vn.gov.hoabinh.service.impl.VcmsAttachedMessageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VcmsAttachedMessage> getAttachedMessageByArticle(
	...
	*/
	...
	public VcmsAttachedMessage addAttachedMessage(long groupId,
		java.lang.String createdByUser, java.lang.String articleId,
	...
	*/
	public VcmsAttachedMessage createVcmsAttachedMessage(
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VcmsAttachedMessage fetchVcmsAttachedMessage(
		java.lang.String messageId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VcmsAttachedMessage getVcmsAttachedMessage(
		java.lang.String messageId) throws PortalException;

	public VcmsAttachedMessage updateAttachedMessage(
