...
/**
 * Provides the local service utility for VLegalFORel. This utility wraps
 * {@link vn.gov.hoabinh.service.impl.VLegalFORelLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class VLegalFORelLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.gov.hoabinh.service.impl.VLegalFORelLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static int getVLegalFORelsCount() {
		return getService().getVLegalFORelsCount();
	}
	...
	*/
	public static java.util.List<vn.gov.hoabinh.model.VLegalFORel> getVLegalFORels(
		int start, int end) {
		return getService().getVLegalFORels(start, end);
	}
	...
	*/
	...
	public static vn.gov.hoabinh.model.VLegalFORel addRelation(
	...
	*/
	public static vn.gov.hoabinh.model.VLegalFORel addVLegalFORel(
		vn.gov.hoabinh.model.VLegalFORel vLegalFORel) {
		return getService().addVLegalFORel(vLegalFORel);
	}
	...
	*/
	public static vn.gov.hoabinh.model.VLegalFORel createVLegalFORel(
		vn.gov.hoabinh.service.persistence.VLegalFORelPK vLegalFORelPK) {
		return getService().createVLegalFORel(vLegalFORelPK);
	}
	...
	*/
	public static vn.gov.hoabinh.model.VLegalFORel deleteVLegalFORel(
		vn.gov.hoabinh.model.VLegalFORel vLegalFORel) {
		return getService().deleteVLegalFORel(vLegalFORel);
	}
	...
	*/
	public static vn.gov.hoabinh.model.VLegalFORel deleteVLegalFORel(
		vn.gov.hoabinh.service.persistence.VLegalFORelPK vLegalFORelPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteVLegalFORel(vLegalFORelPK);
	}

	public static vn.gov.hoabinh.model.VLegalFORel fetchVLegalFORel(
		vn.gov.hoabinh.service.persistence.VLegalFORelPK vLegalFORelPK) {
		return getService().fetchVLegalFORel(vLegalFORelPK);
	}
	...
	* @throws PortalException if a v legal f o rel with the primary key could not be found
	*/
	public static vn.gov.hoabinh.model.VLegalFORel getVLegalFORel(
		vn.gov.hoabinh.service.persistence.VLegalFORelPK vLegalFORelPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getVLegalFORel(vLegalFORelPK);
	}
	...
	*/
	public static vn.gov.hoabinh.model.VLegalFORel updateVLegalFORel(
		vn.gov.hoabinh.model.VLegalFORel vLegalFORel) {
		return getService().updateVLegalFORel(vLegalFORel);
	}
	...
	public static VLegalFORelLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<VLegalFORelLocalService, VLegalFORelLocalService> _serviceTracker =
		ServiceTrackerFactory.open(VLegalFORelLocalService.class);
}