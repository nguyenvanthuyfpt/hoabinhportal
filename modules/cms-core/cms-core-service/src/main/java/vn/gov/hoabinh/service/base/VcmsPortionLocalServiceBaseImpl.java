...
/**
 * Provides the base implementation for the vcms portion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsPortionLocalServiceImpl}.
 * </p>
 *
...
public abstract class VcmsPortionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsPortionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsPortionLocalServiceUtil} to access the vcms portion local service.
	 */
	...
	public VcmsPortion addVcmsPortion(VcmsPortion vcmsPortion) {
		...
		return vcmsPortionPersistence.update(vcmsPortion);
	}
	...
	@Override
	public VcmsPortion deleteVcmsPortion(String portionId)
		throws PortalException {
		return vcmsPortionPersistence.remove(portionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VcmsPortion deleteVcmsPortion(VcmsPortion vcmsPortion) {
		return vcmsPortionPersistence.remove(vcmsPortion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsPortion.class,
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsPortionLocalService.deleteVcmsPortion((VcmsPortion)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsPortion",
			vcmsPortionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsPortion");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsPortionLocalService.class.getName();
	}
