...
/**
 * Provides the base implementation for the v legal attached message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalAttachedMessageLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalAttachedMessageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalAttachedMessageLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalAttachedMessageLocalServiceUtil} to access the v legal attached message local service.
	 */
	...
	public VLegalAttachedMessage addVLegalAttachedMessage(
		...
		return vLegalAttachedMessagePersistence.update(vLegalAttachedMessage);
	}
	 ...
	 */
	@Override
	public VLegalAttachedMessage createVLegalAttachedMessage(String messageId) {
		return vLegalAttachedMessagePersistence.create(messageId);
	}
	...
	@Override
	public VLegalAttachedMessage deleteVLegalAttachedMessage(String messageId)
		throws PortalException {
		return vLegalAttachedMessagePersistence.remove(messageId);
	}
	...
	public VLegalAttachedMessage deleteVLegalAttachedMessage(
		VLegalAttachedMessage vLegalAttachedMessage) {
		return vLegalAttachedMessagePersistence.remove(vLegalAttachedMessage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalAttachedMessage.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalAttachedMessagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalAttachedMessagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VLegalAttachedMessage fetchVLegalAttachedMessage(String messageId) {
		return vLegalAttachedMessagePersistence.fetchByPrimaryKey(messageId);
	}
	 ...
	 */
	@Override
	public VLegalAttachedMessage getVLegalAttachedMessage(String messageId)
		throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalAttachedMessageLocalService.deleteVLegalAttachedMessage((VLegalAttachedMessage)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalAttachedMessagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VLegalAttachedMessage> getVLegalAttachedMessages(int start,
		int end) {
		return vLegalAttachedMessagePersistence.findAll(start, end);
	}
	...
	public int getVLegalAttachedMessagesCount() {
		return vLegalAttachedMessagePersistence.countAll();
	}
	 ...
	 */
	public VLegalAttachedMessageLocalService getVLegalAttachedMessageLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalAttachedMessage",
			vLegalAttachedMessageLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalAttachedMessage");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalAttachedMessageLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalAttachedMessageLocalService.class)
	protected VLegalAttachedMessageLocalService vLegalAttachedMessageLocalService;
