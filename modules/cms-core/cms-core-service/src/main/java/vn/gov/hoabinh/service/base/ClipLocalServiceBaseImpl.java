...
/**
 * Provides the base implementation for the clip local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.ClipLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class ClipLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ClipLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.ClipLocalServiceUtil} to access the clip local service.
	 */
	...
	public Clip addClip(Clip clip) {
		...
		return clipPersistence.update(clip);
	}
	...
	@Override
	public Clip deleteClip(String id) throws PortalException {
		return clipPersistence.remove(id);
	}
	...
	public Clip deleteClip(Clip clip) {
		return clipPersistence.remove(clip);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Clip.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return clipPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Clip fetchClip(String id) {
	 ...
	 */
	@Override
	public Clip getClip(String id) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return clipLocalService.deleteClip((Clip)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.Clip",
			clipLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.Clip");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClipLocalService.class.getName();
	}
