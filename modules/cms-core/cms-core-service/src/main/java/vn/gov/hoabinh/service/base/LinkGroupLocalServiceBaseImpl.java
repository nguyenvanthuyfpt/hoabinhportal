...
/**
 * Provides the base implementation for the link group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.LinkGroupLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class LinkGroupLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LinkGroupLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.LinkGroupLocalServiceUtil} to access the link group local service.
	 */
	...
	public LinkGroup addLinkGroup(LinkGroup linkGroup) {
		...
		return linkGroupPersistence.update(linkGroup);
	}
	 ...
	 */
	@Override
	public LinkGroup createLinkGroup(long linkgroupId) {
		return linkGroupPersistence.create(linkgroupId);
	}
	...
	@Override
	public LinkGroup deleteLinkGroup(long linkgroupId)
		throws PortalException {
		return linkGroupPersistence.remove(linkgroupId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LinkGroup deleteLinkGroup(LinkGroup linkGroup) {
		return linkGroupPersistence.remove(linkGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LinkGroup.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return linkGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return linkGroupPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return linkGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LinkGroup fetchLinkGroup(long linkgroupId) {
		return linkGroupPersistence.fetchByPrimaryKey(linkgroupId);
	}
	...
	public LinkGroup getLinkGroup(long linkgroupId) throws PortalException {
		return linkGroupPersistence.findByPrimaryKey(linkgroupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(linkGroupLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LinkGroup.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("linkgroupId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(linkGroupLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LinkGroup.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("linkgroupId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return linkGroupLocalService.deleteLinkGroup((LinkGroup)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return linkGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LinkGroup> getLinkGroups(int start, int end) {
		return linkGroupPersistence.findAll(start, end);
	}
	...
	public int getLinkGroupsCount() {
		return linkGroupPersistence.countAll();
	}
	 ...
	 */
	public LinkGroupLocalService getLinkGroupLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.LinkGroup",
			linkGroupLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.LinkGroup");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LinkGroupLocalService.class.getName();
	}
	...
	@BeanReference(type = LinkGroupLocalService.class)
	protected LinkGroupLocalService linkGroupLocalService;
