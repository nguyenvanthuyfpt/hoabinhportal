 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.LinksLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class LinksLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LinksLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.LinksLocalServiceUtil} to access the links local service.
	 */
	...
	public Links createLinks(long linkId) {
		return linksPersistence.create(linkId);
	}
	...
	public Links deleteLinks(long linkId) throws PortalException {
		return linksPersistence.remove(linkId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Links.class,
	...
	public Links fetchLinks(long linkId) {
		return linksPersistence.fetchByPrimaryKey(linkId);
	}
	...
	public Links getLinks(long linkId) throws PortalException {
		return linksPersistence.findByPrimaryKey(linkId);
	}
	 ...
	 */
	public LinksLocalService getLinksLocalService() {
	 ...
	 */
	public void setLinksLocalService(LinksLocalService linksLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.Links",
			linksLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.Links");
	}
	...
	@BeanReference(type = LinksLocalService.class)
