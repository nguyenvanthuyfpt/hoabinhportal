...
/**
 * Provides the base implementation for the vcms discussion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsDiscussionLocalServiceImpl}.
 * </p>
 *
...
public abstract class VcmsDiscussionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsDiscussionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsDiscussionLocalServiceUtil} to access the vcms discussion local service.
	 */
	...
	public VcmsDiscussion addVcmsDiscussion(VcmsDiscussion vcmsDiscussion) {
		...
		return vcmsDiscussionPersistence.update(vcmsDiscussion);
	}
	...
	@Override
	public VcmsDiscussion deleteVcmsDiscussion(String discussionId)
		throws PortalException {
		return vcmsDiscussionPersistence.remove(discussionId);
	}
	...
	public VcmsDiscussion deleteVcmsDiscussion(VcmsDiscussion vcmsDiscussion) {
		return vcmsDiscussionPersistence.remove(vcmsDiscussion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsDiscussion.class,
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsDiscussionLocalService.deleteVcmsDiscussion((VcmsDiscussion)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsDiscussion",
			vcmsDiscussionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsDiscussion");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsDiscussionLocalService.class.getName();
	}
