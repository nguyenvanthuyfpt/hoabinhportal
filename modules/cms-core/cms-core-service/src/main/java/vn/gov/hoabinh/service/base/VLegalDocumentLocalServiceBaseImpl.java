...
/**
 * Provides the base implementation for the v legal document local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalDocumentLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalDocumentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalDocumentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalDocumentLocalServiceUtil} to access the v legal document local service.
	 */
	...
	public VLegalDocument addVLegalDocument(VLegalDocument vLegalDocument) {
		...
		return vLegalDocumentPersistence.update(vLegalDocument);
	}
	 ...
	 */
	@Override
	public VLegalDocument createVLegalDocument(String docId) {
		return vLegalDocumentPersistence.create(docId);
	}
	...
	@Override
	public VLegalDocument deleteVLegalDocument(String docId)
		throws PortalException {
		return vLegalDocumentPersistence.remove(docId);
	}
	...
	public VLegalDocument deleteVLegalDocument(VLegalDocument vLegalDocument) {
		return vLegalDocumentPersistence.remove(vLegalDocument);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalDocument.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalDocumentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalDocumentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VLegalDocument fetchVLegalDocument(String docId) {
		return vLegalDocumentPersistence.fetchByPrimaryKey(docId);
	}
	 ...
	 */
	@Override
	public VLegalDocument getVLegalDocument(String docId)
		throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalDocumentLocalService.deleteVLegalDocument((VLegalDocument)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalDocumentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VLegalDocument> getVLegalDocuments(int start, int end) {
		return vLegalDocumentPersistence.findAll(start, end);
	}
	...
	public int getVLegalDocumentsCount() {
		return vLegalDocumentPersistence.countAll();
	}
	 ...
	 */
	public VLegalDocumentLocalService getVLegalDocumentLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalDocument",
			vLegalDocumentLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalDocument");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalDocumentLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalDocumentLocalService.class)
	protected VLegalDocumentLocalService vLegalDocumentLocalService;
