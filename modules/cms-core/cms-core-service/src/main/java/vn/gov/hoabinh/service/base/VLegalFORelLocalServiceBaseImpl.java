...
import vn.gov.hoabinh.service.VLegalFORelLocalService;
...
/**
 * Provides the base implementation for the v legal f o rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalFORelLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalFORelLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalFORelLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalFORelLocalServiceUtil} to access the v legal f o rel local service.
	 */
	...
	public VLegalFORel addVLegalFORel(VLegalFORel vLegalFORel) {
		...
		return vLegalFORelPersistence.update(vLegalFORel);
	}
	...
	public VLegalFORel createVLegalFORel(VLegalFORelPK vLegalFORelPK) {
		return vLegalFORelPersistence.create(vLegalFORelPK);
	}
	...
	public VLegalFORel deleteVLegalFORel(VLegalFORelPK vLegalFORelPK)
		...
		return vLegalFORelPersistence.remove(vLegalFORelPK);
	}
	...
	public VLegalFORel deleteVLegalFORel(VLegalFORel vLegalFORel) {
		return vLegalFORelPersistence.remove(vLegalFORel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalFORel.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalFORelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vLegalFORelPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalFORelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VLegalFORel fetchVLegalFORel(VLegalFORelPK vLegalFORelPK) {
		return vLegalFORelPersistence.fetchByPrimaryKey(vLegalFORelPK);
	}
	...
	public VLegalFORel getVLegalFORel(VLegalFORelPK vLegalFORelPK)
		throws PortalException {
		return vLegalFORelPersistence.findByPrimaryKey(vLegalFORelPK);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalFORelLocalService.deleteVLegalFORel((VLegalFORel)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalFORelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VLegalFORel> getVLegalFORels(int start, int end) {
		return vLegalFORelPersistence.findAll(start, end);
	}
	...
	public int getVLegalFORelsCount() {
		return vLegalFORelPersistence.countAll();
	}
	 ...
	 */
	public VLegalFORelLocalService getVLegalFORelLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalFORel",
			vLegalFORelLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalFORel");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalFORelLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalFORelLocalService.class)
	protected VLegalFORelLocalService vLegalFORelLocalService;
