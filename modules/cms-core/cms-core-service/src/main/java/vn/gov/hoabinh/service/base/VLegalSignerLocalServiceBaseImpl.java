...
/**
 * Provides the base implementation for the v legal signer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalSignerLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalSignerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalSignerLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalSignerLocalServiceUtil} to access the v legal signer local service.
	 */
	...
	public VLegalSigner addVLegalSigner(VLegalSigner vLegalSigner) {
		...
		return vLegalSignerPersistence.update(vLegalSigner);
	}
	 ...
	 */
	@Override
	public VLegalSigner createVLegalSigner(String sigId) {
		return vLegalSignerPersistence.create(sigId);
	}
	...
	@Override
	public VLegalSigner deleteVLegalSigner(String sigId)
		throws PortalException {
		return vLegalSignerPersistence.remove(sigId);
	}
	...
	public VLegalSigner deleteVLegalSigner(VLegalSigner vLegalSigner) {
		return vLegalSignerPersistence.remove(vLegalSigner);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalSigner.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalSignerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalSignerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VLegalSigner fetchVLegalSigner(String sigId) {
		return vLegalSignerPersistence.fetchByPrimaryKey(sigId);
	}
	 ...
	 */
	@Override
	public VLegalSigner getVLegalSigner(String sigId) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalSignerLocalService.deleteVLegalSigner((VLegalSigner)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalSignerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VLegalSigner> getVLegalSigners(int start, int end) {
		return vLegalSignerPersistence.findAll(start, end);
	}
	...
	public int getVLegalSignersCount() {
		return vLegalSignerPersistence.countAll();
	}
	 ...
	 */
	public VLegalSignerLocalService getVLegalSignerLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalSigner",
			vLegalSignerLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalSigner");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalSignerLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalSignerLocalService.class)
	protected VLegalSignerLocalService vLegalSignerLocalService;
