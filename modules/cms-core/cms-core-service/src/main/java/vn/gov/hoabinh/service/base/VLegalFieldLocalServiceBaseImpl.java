...
/**
 * Provides the base implementation for the v legal field local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalFieldLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalFieldLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalFieldLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalFieldLocalServiceUtil} to access the v legal field local service.
	 */
	...
	public VLegalField addVLegalField(VLegalField vLegalField) {
		...
		return vLegalFieldPersistence.update(vLegalField);
	}
	 ...
	 */
	@Override
	public VLegalField createVLegalField(String fieldId) {
		return vLegalFieldPersistence.create(fieldId);
	}
	...
	@Override
	public VLegalField deleteVLegalField(String fieldId)
		throws PortalException {
		return vLegalFieldPersistence.remove(fieldId);
	}
	...
	public VLegalField deleteVLegalField(VLegalField vLegalField) {
		return vLegalFieldPersistence.remove(vLegalField);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalField.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalFieldPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vLegalFieldPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalFieldPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VLegalField fetchVLegalField(String fieldId) {
		return vLegalFieldPersistence.fetchByPrimaryKey(fieldId);
	}
	 ...
	 */
	@Override
	public VLegalField getVLegalField(String fieldId) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalFieldLocalService.deleteVLegalField((VLegalField)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalFieldPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VLegalField> getVLegalFields(int start, int end) {
		return vLegalFieldPersistence.findAll(start, end);
	}
	...
	public int getVLegalFieldsCount() {
		return vLegalFieldPersistence.countAll();
	}
	 ...
	 */
	public VLegalFieldLocalService getVLegalFieldLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalField",
			vLegalFieldLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalField");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalFieldLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalFieldLocalService.class)
	protected VLegalFieldLocalService vLegalFieldLocalService;
