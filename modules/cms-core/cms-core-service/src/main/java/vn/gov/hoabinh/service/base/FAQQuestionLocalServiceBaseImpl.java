...
/**
 * Provides the base implementation for the f a q question local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.FAQQuestionLocalServiceImpl}.
 * </p>
 *
...
public abstract class FAQQuestionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FAQQuestionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.FAQQuestionLocalServiceUtil} to access the f a q question local service.
	 */
	...
	public FAQQuestion addFAQQuestion(FAQQuestion faqQuestion) {
		...
		return faqQuestionPersistence.update(faqQuestion);
	}
	...
	public FAQQuestion deleteFAQQuestion(long id) throws PortalException {
		return faqQuestionPersistence.remove(id);
	}
	...
	public FAQQuestion deleteFAQQuestion(FAQQuestion faqQuestion) {
		return faqQuestionPersistence.remove(faqQuestion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FAQQuestion.class,
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(faqQuestionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FAQQuestion.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(faqQuestionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FAQQuestion.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return faqQuestionLocalService.deleteFAQQuestion((FAQQuestion)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.FAQQuestion",
			faqQuestionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.FAQQuestion");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FAQQuestionLocalService.class.getName();
	}
