...
import vn.gov.hoabinh.service.VcmsLoggerLocalService;
...
/**
 * Provides the base implementation for the vcms logger local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsLoggerLocalServiceImpl}.
 * </p>
 *
...
public abstract class VcmsLoggerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsLoggerLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsLoggerLocalServiceUtil} to access the vcms logger local service.
	 */
	...
	public VcmsLogger addVcmsLogger(VcmsLogger vcmsLogger) {
		...
		return vcmsLoggerPersistence.update(vcmsLogger);
	}
	...
	@Override
	public VcmsLogger deleteVcmsLogger(String loggerId)
		throws PortalException {
		return vcmsLoggerPersistence.remove(loggerId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VcmsLogger deleteVcmsLogger(VcmsLogger vcmsLogger) {
		return vcmsLoggerPersistence.remove(vcmsLogger);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsLogger.class,
	 ...
	 */
	@Override
	public VcmsLogger getVcmsLogger(String loggerId) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsLoggerLocalService.deleteVcmsLogger((VcmsLogger)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsLogger",
			vcmsLoggerLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsLogger");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsLoggerLocalService.class.getName();
	}
