...
import vn.gov.hoabinh.service.FAQCategoryQuestionLocalService;
...
/**
 * Provides the base implementation for the f a q category question local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.FAQCategoryQuestionLocalServiceImpl}.
 * </p>
 *
...
public abstract class FAQCategoryQuestionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FAQCategoryQuestionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.FAQCategoryQuestionLocalServiceUtil} to access the f a q category question local service.
	 */
	...
	public FAQCategoryQuestion addFAQCategoryQuestion(
		...
		return faqCategoryQuestionPersistence.update(faqCategoryQuestion);
	}
	...
	public FAQCategoryQuestion deleteFAQCategoryQuestion(long id)
		...
		return faqCategoryQuestionPersistence.remove(id);
	}
	...
	public FAQCategoryQuestion deleteFAQCategoryQuestion(
		FAQCategoryQuestion faqCategoryQuestion) {
		return faqCategoryQuestionPersistence.remove(faqCategoryQuestion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FAQCategoryQuestion.class,
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(faqCategoryQuestionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FAQCategoryQuestion.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(faqCategoryQuestionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FAQCategoryQuestion.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return faqCategoryQuestionLocalService.deleteFAQCategoryQuestion((FAQCategoryQuestion)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.FAQCategoryQuestion",
			faqCategoryQuestionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.FAQCategoryQuestion");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FAQCategoryQuestionLocalService.class.getName();
	}
