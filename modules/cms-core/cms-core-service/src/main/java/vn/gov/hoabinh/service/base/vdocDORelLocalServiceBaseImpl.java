...
import vn.gov.hoabinh.service.vdocDORelLocalService;
...
/**
 * Provides the base implementation for the vdoc d o rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.vdocDORelLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class vdocDORelLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements vdocDORelLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.vdocDORelLocalServiceUtil} to access the vdoc d o rel local service.
	 */
	...
	public vdocDORel addvdocDORel(vdocDORel vdocDORel) {
		...
		return vdocDORelPersistence.update(vdocDORel);
	}
	...
	public vdocDORel deletevdocDORel(vdocDORelPK vdocDORelPK)
		...
		return vdocDORelPersistence.remove(vdocDORelPK);
	}
	...
	public vdocDORel deletevdocDORel(vdocDORel vdocDORel) {
		return vdocDORelPersistence.remove(vdocDORel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(vdocDORel.class,
	...
	public vdocDORel fetchvdocDORel(vdocDORelPK vdocDORelPK) {
		return vdocDORelPersistence.fetchByPrimaryKey(vdocDORelPK);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vdocDORelLocalService.deletevdocDORel((vdocDORel)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vdocDORelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.vdocDORel",
			vdocDORelLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.vdocDORel");
	}
	...
	public String getOSGiServiceIdentifier() {
		return vdocDORelLocalService.class.getName();
	}
