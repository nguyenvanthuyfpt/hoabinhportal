...
import vn.gov.hoabinh.service.vdocLoggerLocalService;
...
/**
 * Provides the base implementation for the vdoc logger local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.vdocLoggerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see vn.gov.hoabinh.service.impl.vdocLoggerLocalServiceImpl
 * @see vn.gov.hoabinh.service.vdocLoggerLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class vdocLoggerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements vdocLoggerLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.vdocLoggerLocalServiceUtil} to access the vdoc logger local service.
	 */
	...
	public vdocLogger addvdocLogger(vdocLogger vdocLogger) {
		...
		return vdocLoggerPersistence.update(vdocLogger);
	}
	...
	@Override
	public vdocLogger deletevdocLogger(String loggerId)
		throws PortalException {
		return vdocLoggerPersistence.remove(loggerId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public vdocLogger deletevdocLogger(vdocLogger vdocLogger) {
		return vdocLoggerPersistence.remove(vdocLogger);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(vdocLogger.class,
	...
	@Override
	public vdocLogger fetchvdocLogger(String loggerId) {
		return vdocLoggerPersistence.fetchByPrimaryKey(loggerId);
	}
	 ...
	 */
	@Override
	public vdocLogger getvdocLogger(String loggerId) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vdocLoggerLocalService.deletevdocLogger((vdocLogger)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vdocLoggerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.vdocLogger",
			vdocLoggerLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.vdocLogger");
	}
	...
	public String getOSGiServiceIdentifier() {
		return vdocLoggerLocalService.class.getName();
	}
