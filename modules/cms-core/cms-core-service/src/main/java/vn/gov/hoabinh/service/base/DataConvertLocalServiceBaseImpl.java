...
import vn.gov.hoabinh.service.DataConvertLocalService;
...
/**
 * Provides the base implementation for the data convert local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.DataConvertLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class DataConvertLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DataConvertLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.DataConvertLocalServiceUtil} to access the data convert local service.
	 */
	...
	@Override
	public DataConvert addDataConvert(DataConvert dataConvert) {
		dataConvert.setNew(true);

		return dataConvertPersistence.update(dataConvert);
	}
	 ...
	 */
	@Override
	public DataConvert createDataConvert(long id) {
		return dataConvertPersistence.create(id);
	}
	...
	@Override
	public DataConvert deleteDataConvert(long id) throws PortalException {
		return dataConvertPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DataConvert deleteDataConvert(DataConvert dataConvert) {
		return dataConvertPersistence.remove(dataConvert);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DataConvert.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dataConvertPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return dataConvertPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dataConvertPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DataConvert fetchDataConvert(long id) {
		return dataConvertPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DataConvert getDataConvert(long id) throws PortalException {
		return dataConvertPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dataConvertLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DataConvert.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(dataConvertLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DataConvert.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return dataConvertLocalService.deleteDataConvert((DataConvert)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return dataConvertPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DataConvert> getDataConverts(int start, int end) {
		return dataConvertPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDataConvertsCount() {
		return dataConvertPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DataConvert updateDataConvert(DataConvert dataConvert) {
		return dataConvertPersistence.update(dataConvert);
	}
	 ...
	 */
	public DataConvertLocalService getDataConvertLocalService() {
	...
	public void setDataConvertLocalService(
		DataConvertLocalService dataConvertLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.DataConvert",
			dataConvertLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.DataConvert");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DataConvertLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dataConvertPersistence.getDataSource();
	...
	@BeanReference(type = DataConvertLocalService.class)
	protected DataConvertLocalService dataConvertLocalService;
