...
import vn.gov.hoabinh.service.VcmsThreadLocalService;
...
/**
 * Provides the base implementation for the vcms thread local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsThreadLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see vn.gov.hoabinh.service.impl.VcmsThreadLocalServiceImpl
 * @see vn.gov.hoabinh.service.VcmsThreadLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VcmsThreadLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsThreadLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsThreadLocalServiceUtil} to access the vcms thread local service.
	 */
	...
	public VcmsThread addVcmsThread(VcmsThread vcmsThread) {
		...
		return vcmsThreadPersistence.update(vcmsThread);
	}
	...
	@Override
	public VcmsThread deleteVcmsThread(String threadId)
		throws PortalException {
		return vcmsThreadPersistence.remove(threadId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VcmsThread deleteVcmsThread(VcmsThread vcmsThread) {
		return vcmsThreadPersistence.remove(vcmsThread);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsThread.class,
	 ...
	 */
	@Override
	public VcmsThread getVcmsThread(String threadId) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsThreadLocalService.deleteVcmsThread((VcmsThread)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsThread",
			vcmsThreadLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsThread");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsThreadLocalService.class.getName();
	}
