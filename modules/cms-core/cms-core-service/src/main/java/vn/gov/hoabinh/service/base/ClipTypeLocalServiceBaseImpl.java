...
/**
 * Provides the base implementation for the clip type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.ClipTypeLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class ClipTypeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ClipTypeLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.ClipTypeLocalServiceUtil} to access the clip type local service.
	 */
	...
	public ClipType addClipType(ClipType clipType) {
		...
		return clipTypePersistence.update(clipType);
	}
	...
	@Override
	public ClipType deleteClipType(String id) throws PortalException {
		return clipTypePersistence.remove(id);
	}
	...
	public ClipType deleteClipType(ClipType clipType) {
		return clipTypePersistence.remove(clipType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ClipType.class,
	...
	@Override
	public ClipType fetchClipType(String id) {
	 ...
	 */
	@Override
	public ClipType getClipType(String id) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return clipTypeLocalService.deleteClipType((ClipType)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.ClipType",
			clipTypeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.ClipType");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClipTypeLocalService.class.getName();
	}
