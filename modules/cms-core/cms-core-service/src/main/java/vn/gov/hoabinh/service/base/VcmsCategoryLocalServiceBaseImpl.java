...
/**
 * Provides the base implementation for the vcms category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsCategoryLocalServiceImpl}.
 * </p>
 *
...
public abstract class VcmsCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsCategoryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsCategoryLocalServiceUtil} to access the vcms category local service.
	 */
	...
	public VcmsCategory addVcmsCategory(VcmsCategory vcmsCategory) {
		...
		return vcmsCategoryPersistence.update(vcmsCategory);
	}
	...
	@Override
	public VcmsCategory deleteVcmsCategory(String categoryId)
		throws PortalException {
		return vcmsCategoryPersistence.remove(categoryId);
	}
	...
	public VcmsCategory deleteVcmsCategory(VcmsCategory vcmsCategory) {
		return vcmsCategoryPersistence.remove(vcmsCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsCategory.class,
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsCategoryLocalService.deleteVcmsCategory((VcmsCategory)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsCategory",
			vcmsCategoryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsCategory");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsCategoryLocalService.class.getName();
	}
