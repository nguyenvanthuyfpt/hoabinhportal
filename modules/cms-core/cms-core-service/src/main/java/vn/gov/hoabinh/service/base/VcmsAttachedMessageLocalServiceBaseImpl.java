...
/**
 * Provides the base implementation for the vcms attached message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsAttachedMessageLocalServiceImpl}.
 * </p>
 *
...
public abstract class VcmsAttachedMessageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsAttachedMessageLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsAttachedMessageLocalServiceUtil} to access the vcms attached message local service.
	 */
	...
	public VcmsAttachedMessage addVcmsAttachedMessage(
		...
		return vcmsAttachedMessagePersistence.update(vcmsAttachedMessage);
	}
	...
	@Override
	public VcmsAttachedMessage deleteVcmsAttachedMessage(String messageId)
		throws PortalException {
		return vcmsAttachedMessagePersistence.remove(messageId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VcmsAttachedMessage deleteVcmsAttachedMessage(
		VcmsAttachedMessage vcmsAttachedMessage) {
		return vcmsAttachedMessagePersistence.remove(vcmsAttachedMessage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsAttachedMessage.class,
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsAttachedMessageLocalService.deleteVcmsAttachedMessage((VcmsAttachedMessage)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsAttachedMessage",
			vcmsAttachedMessageLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsAttachedMessage");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsAttachedMessageLocalService.class.getName();
	}
