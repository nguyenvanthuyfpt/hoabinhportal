...
/**
 * Provides the base implementation for the f a q category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.FAQCategoryLocalServiceImpl}.
 * </p>
 *
...
public abstract class FAQCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FAQCategoryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.FAQCategoryLocalServiceUtil} to access the f a q category local service.
	 */
	...
	public FAQCategory deleteFAQCategory(long id) throws PortalException {
		return faqCategoryPersistence.remove(id);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FAQCategory.class,
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(faqCategoryLocalService);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return faqCategoryLocalService.deleteFAQCategory((FAQCategory)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.FAQCategory",
			faqCategoryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.FAQCategory");
	}
