...
/**
 * Provides the base implementation for the vdoc field local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.vdocFieldLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class vdocFieldLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements vdocFieldLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.vdocFieldLocalServiceUtil} to access the vdoc field local service.
	 */
	...
	public vdocField addvdocField(vdocField vdocField) {
		...
		return vdocFieldPersistence.update(vdocField);
	}
	...
	@Override
	public vdocField deletevdocField(String fieldId) throws PortalException {
		return vdocFieldPersistence.remove(fieldId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public vdocField deletevdocField(vdocField vdocField) {
		return vdocFieldPersistence.remove(vdocField);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(vdocField.class,
	...
	@Override
	public vdocField fetchvdocField(String fieldId) {
		return vdocFieldPersistence.fetchByPrimaryKey(fieldId);
	}
	 ...
	 */
	@Override
	public vdocField getvdocField(String fieldId) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vdocFieldLocalService.deletevdocField((vdocField)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vdocFieldPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.vdocField",
			vdocFieldLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.vdocField");
	}
	...
	public String getOSGiServiceIdentifier() {
		return vdocFieldLocalService.class.getName();
	}
