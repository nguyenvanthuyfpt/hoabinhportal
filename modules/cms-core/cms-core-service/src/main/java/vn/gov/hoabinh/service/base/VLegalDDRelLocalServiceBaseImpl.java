...
import vn.gov.hoabinh.service.VLegalDDRelLocalService;
...
/**
 * Provides the base implementation for the v legal d d rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalDDRelLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalDDRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalDDRelLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalDDRelLocalServiceUtil} to access the v legal d d rel local service.
	 */
	...
	public VLegalDDRel addVLegalDDRel(VLegalDDRel vLegalDDRel) {
		...
		return vLegalDDRelPersistence.update(vLegalDDRel);
	}
	...
	public VLegalDDRel createVLegalDDRel(VLegalDDRelPK vLegalDDRelPK) {
		return vLegalDDRelPersistence.create(vLegalDDRelPK);
	}
	...
	public VLegalDDRel deleteVLegalDDRel(VLegalDDRelPK vLegalDDRelPK)
		...
		return vLegalDDRelPersistence.remove(vLegalDDRelPK);
	}
	...
	public VLegalDDRel deleteVLegalDDRel(VLegalDDRel vLegalDDRel) {
		return vLegalDDRelPersistence.remove(vLegalDDRel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalDDRel.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalDDRelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vLegalDDRelPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalDDRelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VLegalDDRel fetchVLegalDDRel(VLegalDDRelPK vLegalDDRelPK) {
		return vLegalDDRelPersistence.fetchByPrimaryKey(vLegalDDRelPK);
	}
	...
	public VLegalDDRel getVLegalDDRel(VLegalDDRelPK vLegalDDRelPK)
		throws PortalException {
		return vLegalDDRelPersistence.findByPrimaryKey(vLegalDDRelPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vLegalDDRelLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VLegalDDRel.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vLegalDDRelLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VLegalDDRel.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalDDRelLocalService.deleteVLegalDDRel((VLegalDDRel)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalDDRelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VLegalDDRel> getVLegalDDRels(int start, int end) {
		return vLegalDDRelPersistence.findAll(start, end);
	}
	...
	public int getVLegalDDRelsCount() {
		return vLegalDDRelPersistence.countAll();
	}
	 ...
	 */
	public VLegalDDRelLocalService getVLegalDDRelLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalDDRel",
			vLegalDDRelLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalDDRel");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalDDRelLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalDDRelLocalService.class)
	protected VLegalDDRelLocalService vLegalDDRelLocalService;
