...
/**
 * Provides the base implementation for the vcms article local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsArticleLocalServiceImpl}.
 * </p>
 *
...
public abstract class VcmsArticleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsArticleLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsArticleLocalServiceUtil} to access the vcms article local service.
	 */
	...
	public VcmsArticle addVcmsArticle(VcmsArticle vcmsArticle) {
		...
		return vcmsArticlePersistence.update(vcmsArticle);
	}
	...
	@Override
	public VcmsArticle deleteVcmsArticle(String articleId)
		throws PortalException {
		return vcmsArticlePersistence.remove(articleId);
	}
	...
	public VcmsArticle deleteVcmsArticle(VcmsArticle vcmsArticle) {
		return vcmsArticlePersistence.remove(vcmsArticle);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsArticle.class,
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsArticleLocalService.deleteVcmsArticle((VcmsArticle)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsArticle",
			vcmsArticleLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsArticle");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsArticleLocalService.class.getName();
	}
