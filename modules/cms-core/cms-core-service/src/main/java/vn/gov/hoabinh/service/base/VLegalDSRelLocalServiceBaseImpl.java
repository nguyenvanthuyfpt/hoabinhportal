...
import vn.gov.hoabinh.service.VLegalDSRelLocalService;
...
/**
 * Provides the base implementation for the v legal d s rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalDSRelLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalDSRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalDSRelLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalDSRelLocalServiceUtil} to access the v legal d s rel local service.
	 */
	...
	public VLegalDSRel addVLegalDSRel(VLegalDSRel vLegalDSRel) {
		...
		return vLegalDSRelPersistence.update(vLegalDSRel);
	}
	...
	public VLegalDSRel createVLegalDSRel(VLegalDSRelPK vLegalDSRelPK) {
		return vLegalDSRelPersistence.create(vLegalDSRelPK);
	}
	...
	public VLegalDSRel deleteVLegalDSRel(VLegalDSRelPK vLegalDSRelPK)
		...
		return vLegalDSRelPersistence.remove(vLegalDSRelPK);
	}
	...
	public VLegalDSRel deleteVLegalDSRel(VLegalDSRel vLegalDSRel) {
		return vLegalDSRelPersistence.remove(vLegalDSRel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalDSRel.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalDSRelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vLegalDSRelPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalDSRelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VLegalDSRel fetchVLegalDSRel(VLegalDSRelPK vLegalDSRelPK) {
		return vLegalDSRelPersistence.fetchByPrimaryKey(vLegalDSRelPK);
	}
	...
	public VLegalDSRel getVLegalDSRel(VLegalDSRelPK vLegalDSRelPK)
		throws PortalException {
		return vLegalDSRelPersistence.findByPrimaryKey(vLegalDSRelPK);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalDSRelLocalService.deleteVLegalDSRel((VLegalDSRel)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalDSRelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VLegalDSRel> getVLegalDSRels(int start, int end) {
		return vLegalDSRelPersistence.findAll(start, end);
	}
	...
	public int getVLegalDSRelsCount() {
		return vLegalDSRelPersistence.countAll();
	}
	 ...
	 */
	public VLegalDSRelLocalService getVLegalDSRelLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalDSRel",
			vLegalDSRelLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalDSRel");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalDSRelLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalDSRelLocalService.class)
	protected VLegalDSRelLocalService vLegalDSRelLocalService;
