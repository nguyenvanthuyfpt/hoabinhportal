...
import vn.gov.hoabinh.service.VLegalLoggerLocalService;
...
/**
 * Provides the base implementation for the v legal logger local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalLoggerLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalLoggerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalLoggerLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalLoggerLocalServiceUtil} to access the v legal logger local service.
	 */
	...
	@Override
	public VLegalLogger addVLegalLogger(VLegalLogger vLegalLogger) {
		vLegalLogger.setNew(true);

		return vLegalLoggerPersistence.update(vLegalLogger);
	}
	 ...
	 */
	@Override
	public VLegalLogger createVLegalLogger(String loggerId) {
		return vLegalLoggerPersistence.create(loggerId);
	}
	...
	@Override
	public VLegalLogger deleteVLegalLogger(String loggerId)
		throws PortalException {
		return vLegalLoggerPersistence.remove(loggerId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VLegalLogger deleteVLegalLogger(VLegalLogger vLegalLogger) {
		return vLegalLoggerPersistence.remove(vLegalLogger);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalLogger.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalLoggerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalLoggerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VLegalLogger fetchVLegalLogger(String loggerId) {
		return vLegalLoggerPersistence.fetchByPrimaryKey(loggerId);
	}
	 ...
	 */
	@Override
	public VLegalLogger getVLegalLogger(String loggerId)
		throws PortalException {
		return vLegalLoggerPersistence.findByPrimaryKey(loggerId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalLoggerLocalService.deleteVLegalLogger((VLegalLogger)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalLoggerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VLegalLogger> getVLegalLoggers(int start, int end) {
		return vLegalLoggerPersistence.findAll(start, end);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VLegalLogger updateVLegalLogger(VLegalLogger vLegalLogger) {
		return vLegalLoggerPersistence.update(vLegalLogger);
	}
	 ...
	 */
	public VLegalLoggerLocalService getVLegalLoggerLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalLogger",
			vLegalLoggerLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalLogger");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalLoggerLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalLoggerLocalService.class)
	protected VLegalLoggerLocalService vLegalLoggerLocalService;
