...
/**
 * Provides the base implementation for the v legal org local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalOrgLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalOrgLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VLegalOrgLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalOrgLocalServiceUtil} to access the v legal org local service.
	 */
	...
	@Override
	public VLegalOrg addVLegalOrg(VLegalOrg vLegalOrg) {
		vLegalOrg.setNew(true);

		return vLegalOrgPersistence.update(vLegalOrg);
	}
	 ...
	 */
	@Override
	public VLegalOrg createVLegalOrg(String orgId) {
		return vLegalOrgPersistence.create(orgId);
	}
	...
	@Override
	public VLegalOrg deleteVLegalOrg(String orgId) throws PortalException {
		return vLegalOrgPersistence.remove(orgId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VLegalOrg deleteVLegalOrg(VLegalOrg vLegalOrg) {
		return vLegalOrgPersistence.remove(vLegalOrg);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalOrg.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalOrgPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vLegalOrgPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalOrgPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VLegalOrg fetchVLegalOrg(String orgId) {
		return vLegalOrgPersistence.fetchByPrimaryKey(orgId);
	}
	 ...
	 */
	@Override
	public VLegalOrg getVLegalOrg(String orgId) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalOrgLocalService.deleteVLegalOrg((VLegalOrg)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalOrgPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VLegalOrg> getVLegalOrgs(int start, int end) {
		return vLegalOrgPersistence.findAll(start, end);
	}
	...
	public int getVLegalOrgsCount() {
		return vLegalOrgPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VLegalOrg updateVLegalOrg(VLegalOrg vLegalOrg) {
		return vLegalOrgPersistence.update(vLegalOrg);
	}
	 ...
	 */
	public VLegalOrgLocalService getVLegalOrgLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalOrg",
			vLegalOrgLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalOrg");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalOrgLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalOrgLocalService.class)
	protected VLegalOrgLocalService vLegalOrgLocalService;
