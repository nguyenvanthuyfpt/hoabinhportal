...
import vn.gov.hoabinh.service.VLegalDURelLocalService;
...
/**
 * Provides the base implementation for the v legal d u rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalDURelLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalDURelLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalDURelLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalDURelLocalServiceUtil} to access the v legal d u rel local service.
	 */
	...
	public VLegalDURel addVLegalDURel(VLegalDURel vLegalDURel) {
		...
		return vLegalDURelPersistence.update(vLegalDURel);
	}
	...
	public VLegalDURel createVLegalDURel(VLegalDURelPK vLegalDURelPK) {
		return vLegalDURelPersistence.create(vLegalDURelPK);
	}
	...
	public VLegalDURel deleteVLegalDURel(VLegalDURelPK vLegalDURelPK)
		...
		return vLegalDURelPersistence.remove(vLegalDURelPK);
	}
	...
	public VLegalDURel deleteVLegalDURel(VLegalDURel vLegalDURel) {
		return vLegalDURelPersistence.remove(vLegalDURel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalDURel.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalDURelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vLegalDURelPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalDURelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VLegalDURel fetchVLegalDURel(VLegalDURelPK vLegalDURelPK) {
		return vLegalDURelPersistence.fetchByPrimaryKey(vLegalDURelPK);
	}
	...
	public VLegalDURel getVLegalDURel(VLegalDURelPK vLegalDURelPK)
		throws PortalException {
		return vLegalDURelPersistence.findByPrimaryKey(vLegalDURelPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vLegalDURelLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VLegalDURel.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vLegalDURelLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VLegalDURel.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalDURelLocalService.deleteVLegalDURel((VLegalDURel)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalDURelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VLegalDURel> getVLegalDURels(int start, int end) {
		return vLegalDURelPersistence.findAll(start, end);
	}
	...
	public int getVLegalDURelsCount() {
		return vLegalDURelPersistence.countAll();
	}
	 ...
	 */
	public VLegalDURelLocalService getVLegalDURelLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalDURel",
			vLegalDURelLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalDURel");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalDURelLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalDURelLocalService.class)
	protected VLegalDURelLocalService vLegalDURelLocalService;
