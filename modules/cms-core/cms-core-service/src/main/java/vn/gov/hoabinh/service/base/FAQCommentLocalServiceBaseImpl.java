...
import vn.gov.hoabinh.service.FAQCommentLocalService;
...
/**
 * Provides the base implementation for the f a q comment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.FAQCommentLocalServiceImpl}.
 * </p>
 *
...
public abstract class FAQCommentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FAQCommentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.FAQCommentLocalServiceUtil} to access the f a q comment local service.
	 */
	...
	public FAQComment addFAQComment(FAQComment faqComment) {
		...
		return faqCommentPersistence.update(faqComment);
	}
	...
	public FAQComment deleteFAQComment(long id) throws PortalException {
		return faqCommentPersistence.remove(id);
	}
	...
	public FAQComment deleteFAQComment(FAQComment faqComment) {
		return faqCommentPersistence.remove(faqComment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FAQComment.class,
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(faqCommentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FAQComment.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(faqCommentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FAQComment.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return faqCommentLocalService.deleteFAQComment((FAQComment)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.FAQComment",
			faqCommentLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.FAQComment");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FAQCommentLocalService.class.getName();
	}
