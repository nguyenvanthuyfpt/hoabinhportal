...
/**
 * Provides the base implementation for the visitor tracker local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VisitorTrackerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see vn.gov.hoabinh.service.impl.VisitorTrackerLocalServiceImpl
 * @see vn.gov.hoabinh.service.VisitorTrackerLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VisitorTrackerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VisitorTrackerLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VisitorTrackerLocalServiceUtil} to access the visitor tracker local service.
	 */
	...
	@Override
	public VisitorTracker addVisitorTracker(VisitorTracker visitorTracker) {
		visitorTracker.setNew(true);

		return visitorTrackerPersistence.update(visitorTracker);
	}
	 ...
	 */
	@Override
	public VisitorTracker createVisitorTracker(long visitorId) {
		return visitorTrackerPersistence.create(visitorId);
	}
	...
	@Override
	public VisitorTracker deleteVisitorTracker(long visitorId)
		throws PortalException {
		return visitorTrackerPersistence.remove(visitorId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VisitorTracker deleteVisitorTracker(VisitorTracker visitorTracker) {
		return visitorTrackerPersistence.remove(visitorTracker);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VisitorTracker.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return visitorTrackerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return visitorTrackerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VisitorTracker fetchVisitorTracker(long visitorId) {
		return visitorTrackerPersistence.fetchByPrimaryKey(visitorId);
	}
	 ...
	 */
	@Override
	public VisitorTracker getVisitorTracker(long visitorId)
		throws PortalException {
		return visitorTrackerPersistence.findByPrimaryKey(visitorId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(visitorTrackerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VisitorTracker.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("visitorId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(visitorTrackerLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VisitorTracker.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("visitorId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return visitorTrackerLocalService.deleteVisitorTracker((VisitorTracker)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return visitorTrackerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VisitorTracker> getVisitorTrackers(int start, int end) {
		return visitorTrackerPersistence.findAll(start, end);
	}
	...
	public int getVisitorTrackersCount() {
		return visitorTrackerPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VisitorTracker updateVisitorTracker(VisitorTracker visitorTracker) {
		return visitorTrackerPersistence.update(visitorTracker);
	}
	 ...
	 */
	public VisitorTrackerLocalService getVisitorTrackerLocalService() {
	 ...
	 */
	public vn.gov.hoabinh.service.VLegalDFRelLocalService getVLegalDFRelLocalService() {
	...
	public void setVLegalDFRelLocalService(
		vn.gov.hoabinh.service.VLegalDFRelLocalService vLegalDFRelLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VisitorTracker",
			visitorTrackerLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VisitorTracker");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VisitorTrackerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = visitorTrackerPersistence.getDataSource();
	...
	@BeanReference(type = VisitorTrackerLocalService.class)
	protected VisitorTrackerLocalService visitorTrackerLocalService;
	...
	@BeanReference(type = vn.gov.hoabinh.service.VLegalDFRelLocalService.class)
	protected vn.gov.hoabinh.service.VLegalDFRelLocalService vLegalDFRelLocalService;
