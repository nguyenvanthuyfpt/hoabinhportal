...
/**
 * Provides the base implementation for the vdoc level local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.vdocLevelLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class vdocLevelLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements vdocLevelLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.vdocLevelLocalServiceUtil} to access the vdoc level local service.
	 */
	...
	public vdocLevel addvdocLevel(vdocLevel vdocLevel) {
		...
		return vdocLevelPersistence.update(vdocLevel);
	}
	 ...
	 */
	@Override
	public vdocLevel createvdocLevel(String levelId) {
		return vdocLevelPersistence.create(levelId);
	}
	...
	@Override
	public vdocLevel deletevdocLevel(String levelId) throws PortalException {
		return vdocLevelPersistence.remove(levelId);
	}
	...
	public vdocLevel deletevdocLevel(vdocLevel vdocLevel) {
		return vdocLevelPersistence.remove(vdocLevel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(vdocLevel.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vdocLevelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vdocLevelPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vdocLevelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public vdocLevel fetchvdocLevel(String levelId) {
		return vdocLevelPersistence.fetchByPrimaryKey(levelId);
	}
	 ...
	 */
	@Override
	public vdocLevel getvdocLevel(String levelId) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vdocLevelLocalService.deletevdocLevel((vdocLevel)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vdocLevelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<vdocLevel> getvdocLevels(int start, int end) {
		return vdocLevelPersistence.findAll(start, end);
	}
	...
	public int getvdocLevelsCount() {
		return vdocLevelPersistence.countAll();
	}
	 ...
	 */
	public vdocLevelLocalService getvdocLevelLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.vdocLevel",
			vdocLevelLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.vdocLevel");
	}
	...
	public String getOSGiServiceIdentifier() {
		return vdocLevelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vdocLevelPersistence.getDataSource();
	...
	@BeanReference(type = vdocLevelLocalService.class)
	protected vdocLevelLocalService vdocLevelLocalService;
