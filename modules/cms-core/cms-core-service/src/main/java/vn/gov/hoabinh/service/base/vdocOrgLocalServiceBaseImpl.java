...
/**
 * Provides the base implementation for the vdoc org local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.vdocOrgLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class vdocOrgLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements vdocOrgLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.vdocOrgLocalServiceUtil} to access the vdoc org local service.
	 */
	...
	public vdocOrg addvdocOrg(vdocOrg vdocOrg) {
		...
		return vdocOrgPersistence.update(vdocOrg);
	}
	...
	@Override
	public vdocOrg deletevdocOrg(String orgId) throws PortalException {
		return vdocOrgPersistence.remove(orgId);
	}
	...
	public vdocOrg deletevdocOrg(vdocOrg vdocOrg) {
		return vdocOrgPersistence.remove(vdocOrg);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(vdocOrg.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return vdocOrgPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public vdocOrg fetchvdocOrg(String orgId) {
		return vdocOrgPersistence.fetchByPrimaryKey(orgId);
	}
	 ...
	 */
	@Override
	public vdocOrg getvdocOrg(String orgId) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vdocOrgLocalService.deletevdocOrg((vdocOrg)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vdocOrgPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.vdocOrg",
			vdocOrgLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.vdocOrg");
	}
	...
	public String getOSGiServiceIdentifier() {
		return vdocOrgLocalService.class.getName();
	}
