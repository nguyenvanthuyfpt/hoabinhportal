...
import vn.gov.hoabinh.service.VcmsTARelationLocalService;
...
/**
 * Provides the base implementation for the vcms t a relation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsTARelationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see vn.gov.hoabinh.service.impl.VcmsTARelationLocalServiceImpl
 * @see vn.gov.hoabinh.service.VcmsTARelationLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VcmsTARelationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsTARelationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsTARelationLocalServiceUtil} to access the vcms t a relation local service.
	 */
	...
	public VcmsTARelation addVcmsTARelation(VcmsTARelation vcmsTARelation) {
		...
		return vcmsTARelationPersistence.update(vcmsTARelation);
	}
	...
	@Override
	public VcmsTARelation deleteVcmsTARelation(
		VcmsTARelationPK vcmsTARelationPK) throws PortalException {
		return vcmsTARelationPersistence.remove(vcmsTARelationPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VcmsTARelation deleteVcmsTARelation(VcmsTARelation vcmsTARelation) {
		return vcmsTARelationPersistence.remove(vcmsTARelation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsTARelation.class,
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsTARelationLocalService.deleteVcmsTARelation((VcmsTARelation)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsTARelation",
			vcmsTARelationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsTARelation");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsTARelationLocalService.class.getName();
	}
