...
/**
 * Provides the base implementation for the v legal type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalTypeLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalTypeLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalTypeLocalServiceUtil} to access the v legal type local service.
	 */
	...
	public VLegalType addVLegalType(VLegalType vLegalType) {
		...
		return vLegalTypePersistence.update(vLegalType);
	}
	 ...
	 */
	@Override
	public VLegalType createVLegalType(String typeId) {
		return vLegalTypePersistence.create(typeId);
	}
	...
	@Override
	public VLegalType deleteVLegalType(String typeId) throws PortalException {
		return vLegalTypePersistence.remove(typeId);
	}
	...
	public VLegalType deleteVLegalType(VLegalType vLegalType) {
		return vLegalTypePersistence.remove(vLegalType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalType.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vLegalTypePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VLegalType fetchVLegalType(String typeId) {
		return vLegalTypePersistence.fetchByPrimaryKey(typeId);
	}
	 ...
	 */
	@Override
	public VLegalType getVLegalType(String typeId) throws PortalException {
		return vLegalTypePersistence.findByPrimaryKey(typeId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalTypeLocalService.deleteVLegalType((VLegalType)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VLegalType> getVLegalTypes(int start, int end) {
		return vLegalTypePersistence.findAll(start, end);
	}
	...
	public int getVLegalTypesCount() {
		return vLegalTypePersistence.countAll();
	}
	 ...
	 */
	public VLegalTypeLocalService getVLegalTypeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalType",
			vLegalTypeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalType");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalTypeLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalTypeLocalService.class)
	protected VLegalTypeLocalService vLegalTypeLocalService;
