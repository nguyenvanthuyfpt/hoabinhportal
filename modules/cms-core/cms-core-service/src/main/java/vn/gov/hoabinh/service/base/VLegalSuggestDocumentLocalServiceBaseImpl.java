...
/**
 * Provides the base implementation for the v legal suggest document local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalSuggestDocumentLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalSuggestDocumentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalSuggestDocumentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalSuggestDocumentLocalServiceUtil} to access the v legal suggest document local service.
	 */
	...
	public VLegalSuggestDocument addVLegalSuggestDocument(
		...
		return vLegalSuggestDocumentPersistence.update(vLegalSuggestDocument);
	}
	 ...
	 */
	@Override
	public VLegalSuggestDocument createVLegalSuggestDocument(String sugId) {
		return vLegalSuggestDocumentPersistence.create(sugId);
	}
	...
	@Override
	public VLegalSuggestDocument deleteVLegalSuggestDocument(String sugId)
		throws PortalException {
		return vLegalSuggestDocumentPersistence.remove(sugId);
	}
	...
	public VLegalSuggestDocument deleteVLegalSuggestDocument(
		VLegalSuggestDocument vLegalSuggestDocument) {
		return vLegalSuggestDocumentPersistence.remove(vLegalSuggestDocument);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalSuggestDocument.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalSuggestDocumentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalSuggestDocumentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VLegalSuggestDocument fetchVLegalSuggestDocument(String sugId) {
		return vLegalSuggestDocumentPersistence.fetchByPrimaryKey(sugId);
	}
	 ...
	 */
	@Override
	public VLegalSuggestDocument getVLegalSuggestDocument(String sugId)
		throws PortalException {
		return vLegalSuggestDocumentPersistence.findByPrimaryKey(sugId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalSuggestDocumentLocalService.deleteVLegalSuggestDocument((VLegalSuggestDocument)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalSuggestDocumentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VLegalSuggestDocument> getVLegalSuggestDocuments(int start,
		int end) {
		return vLegalSuggestDocumentPersistence.findAll(start, end);
	}
	...
	public int getVLegalSuggestDocumentsCount() {
		return vLegalSuggestDocumentPersistence.countAll();
	}
	 ...
	 */
	public VLegalSuggestDocumentLocalService getVLegalSuggestDocumentLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalSuggestDocument",
			vLegalSuggestDocumentLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalSuggestDocument");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalSuggestDocumentLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalSuggestDocumentLocalService.class)
	protected VLegalSuggestDocumentLocalService vLegalSuggestDocumentLocalService;
