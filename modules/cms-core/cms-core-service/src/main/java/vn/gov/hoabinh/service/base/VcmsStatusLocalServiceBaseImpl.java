...
/**
 * Provides the base implementation for the vcms status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsStatusLocalServiceImpl}.
 * </p>
 *
...
public abstract class VcmsStatusLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsStatusLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsStatusLocalServiceUtil} to access the vcms status local service.
	 */
	...
	public VcmsStatus addVcmsStatus(VcmsStatus vcmsStatus) {
		...
		return vcmsStatusPersistence.update(vcmsStatus);
	}
	...
	public VcmsStatus deleteVcmsStatus(long statusId) throws PortalException {
		return vcmsStatusPersistence.remove(statusId);
	}
	...
	public VcmsStatus deleteVcmsStatus(VcmsStatus vcmsStatus) {
		return vcmsStatusPersistence.remove(vcmsStatus);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsStatus.class,
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vcmsStatusLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VcmsStatus.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vcmsStatusLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VcmsStatus.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsStatusLocalService.deleteVcmsStatus((VcmsStatus)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsStatus",
			vcmsStatusLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsStatus");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsStatusLocalService.class.getName();
	}
