...
/**
 * Provides the base implementation for the f a q answer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.FAQAnswerLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class FAQAnswerLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements FAQAnswerLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.FAQAnswerLocalServiceUtil} to access the f a q answer local service.
	 */
	...
	public FAQAnswer addFAQAnswer(FAQAnswer faqAnswer) {
		...
		return faqAnswerPersistence.update(faqAnswer);
	}
	...
	@Override
	public FAQAnswer deleteFAQAnswer(long id) throws PortalException {
		return faqAnswerPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FAQAnswer deleteFAQAnswer(FAQAnswer faqAnswer) {
		return faqAnswerPersistence.remove(faqAnswer);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FAQAnswer.class,
	...
	@Override
	public FAQAnswer fetchFAQAnswer(long id) {
	 ...
	 */
	@Override
	public FAQAnswer getFAQAnswer(long id) throws PortalException {
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(faqAnswerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FAQAnswer.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(faqAnswerLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FAQAnswer.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return faqAnswerLocalService.deleteFAQAnswer((FAQAnswer)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.FAQAnswer",
			faqAnswerLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.FAQAnswer");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FAQAnswerLocalService.class.getName();
	}
