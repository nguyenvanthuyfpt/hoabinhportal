...
import vn.gov.hoabinh.service.VLegalTagsLocalService;
...
/**
 * Provides the base implementation for the v legal tags local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalTagsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see vn.gov.hoabinh.service.impl.VLegalTagsLocalServiceImpl
 * @see vn.gov.hoabinh.service.VLegalTagsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VLegalTagsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalTagsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalTagsLocalServiceUtil} to access the v legal tags local service.
	 */
	...
	@Override
	public VLegalTags addVLegalTags(VLegalTags vLegalTags) {
		vLegalTags.setNew(true);

		return vLegalTagsPersistence.update(vLegalTags);
	}
	 ...
	 */
	@Override
	public VLegalTags createVLegalTags(String tagId) {
		return vLegalTagsPersistence.create(tagId);
	}
	...
	@Override
	public VLegalTags deleteVLegalTags(String tagId) throws PortalException {
		return vLegalTagsPersistence.remove(tagId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VLegalTags deleteVLegalTags(VLegalTags vLegalTags) {
		return vLegalTagsPersistence.remove(vLegalTags);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalTags.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalTagsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vLegalTagsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalTagsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VLegalTags fetchVLegalTags(String tagId) {
		return vLegalTagsPersistence.fetchByPrimaryKey(tagId);
	}
	 ...
	 */
	@Override
	public VLegalTags getVLegalTags(String tagId) throws PortalException {
		return vLegalTagsPersistence.findByPrimaryKey(tagId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalTagsLocalService.deleteVLegalTags((VLegalTags)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalTagsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VLegalTags> getVLegalTagses(int start, int end) {
		return vLegalTagsPersistence.findAll(start, end);
	}
	...
	public int getVLegalTagsesCount() {
		return vLegalTagsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VLegalTags updateVLegalTags(VLegalTags vLegalTags) {
		return vLegalTagsPersistence.update(vLegalTags);
	}
	 ...
	 */
	public VLegalTagsLocalService getVLegalTagsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalTags",
			vLegalTagsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalTags");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalTagsLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalTagsLocalService.class)
	protected VLegalTagsLocalService vLegalTagsLocalService;
