...
import vn.gov.hoabinh.service.VLegalFTRelLocalService;
...
/**
 * Provides the base implementation for the v legal f t rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalFTRelLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalFTRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalFTRelLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalFTRelLocalServiceUtil} to access the v legal f t rel local service.
	 */
	...
	public VLegalFTRel addVLegalFTRel(VLegalFTRel vLegalFTRel) {
		...
		return vLegalFTRelPersistence.update(vLegalFTRel);
	}
	...
	public VLegalFTRel createVLegalFTRel(VLegalFTRelPK vLegalFTRelPK) {
		return vLegalFTRelPersistence.create(vLegalFTRelPK);
	}
	...
	public VLegalFTRel deleteVLegalFTRel(VLegalFTRelPK vLegalFTRelPK)
		...
		return vLegalFTRelPersistence.remove(vLegalFTRelPK);
	}
	...
	public VLegalFTRel deleteVLegalFTRel(VLegalFTRel vLegalFTRel) {
		return vLegalFTRelPersistence.remove(vLegalFTRel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalFTRel.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalFTRelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vLegalFTRelPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalFTRelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VLegalFTRel fetchVLegalFTRel(VLegalFTRelPK vLegalFTRelPK) {
		return vLegalFTRelPersistence.fetchByPrimaryKey(vLegalFTRelPK);
	}
	...
	public VLegalFTRel getVLegalFTRel(VLegalFTRelPK vLegalFTRelPK)
		throws PortalException {
		return vLegalFTRelPersistence.findByPrimaryKey(vLegalFTRelPK);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalFTRelLocalService.deleteVLegalFTRel((VLegalFTRel)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalFTRelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VLegalFTRel> getVLegalFTRels(int start, int end) {
		return vLegalFTRelPersistence.findAll(start, end);
	}
	...
	public int getVLegalFTRelsCount() {
		return vLegalFTRelPersistence.countAll();
	}
	 ...
	 */
	public VLegalFTRelLocalService getVLegalFTRelLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalFTRel",
			vLegalFTRelLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalFTRel");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalFTRelLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalFTRelLocalService.class)
	protected VLegalFTRelLocalService vLegalFTRelLocalService;
