...
import vn.gov.hoabinh.service.VcmsArticleTypeLocalService;
...
/**
 * Provides the base implementation for the vcms article type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsArticleTypeLocalServiceImpl}.
 * </p>
 *
...
public abstract class VcmsArticleTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsArticleTypeLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsArticleTypeLocalServiceUtil} to access the vcms article type local service.
	 */
	...
	public VcmsArticleType addVcmsArticleType(VcmsArticleType vcmsArticleType) {
		...
		return vcmsArticleTypePersistence.update(vcmsArticleType);
	}
	...
	public VcmsArticleType deleteVcmsArticleType(
		...
		return vcmsArticleTypePersistence.remove(vcmsArticleTypePK);
	}
	...
	public VcmsArticleType deleteVcmsArticleType(
		...
		return vcmsArticleTypePersistence.remove(vcmsArticleType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsArticleType.class,
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vcmsArticleTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VcmsArticleType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("primaryKey.typeId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vcmsArticleTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VcmsArticleType.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsArticleTypeLocalService.deleteVcmsArticleType((VcmsArticleType)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsArticleType",
			vcmsArticleTypeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsArticleType");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsArticleTypeLocalService.class.getName();
	}
