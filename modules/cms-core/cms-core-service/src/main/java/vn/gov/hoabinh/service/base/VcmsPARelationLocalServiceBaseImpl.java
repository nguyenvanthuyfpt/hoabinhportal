...
import vn.gov.hoabinh.service.VcmsPARelationLocalService;
...
/**
 * Provides the base implementation for the vcms p a relation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsPARelationLocalServiceImpl}.
 * </p>
 *
...
public abstract class VcmsPARelationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsPARelationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsPARelationLocalServiceUtil} to access the vcms p a relation local service.
	 */
	...
	public VcmsPARelation addVcmsPARelation(VcmsPARelation vcmsPARelation) {
		...
		return vcmsPARelationPersistence.update(vcmsPARelation);
	}
	...
	@Override
	public VcmsPARelation deleteVcmsPARelation(
		VcmsPARelationPK vcmsPARelationPK) throws PortalException {
		return vcmsPARelationPersistence.remove(vcmsPARelationPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VcmsPARelation deleteVcmsPARelation(VcmsPARelation vcmsPARelation) {
		return vcmsPARelationPersistence.remove(vcmsPARelation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsPARelation.class,
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsPARelationLocalService.deleteVcmsPARelation((VcmsPARelation)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsPARelation",
			vcmsPARelationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsPARelation");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsPARelationLocalService.class.getName();
	}
