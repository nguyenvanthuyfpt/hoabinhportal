...
import vn.gov.hoabinh.service.VcmsCARelationLocalService;
...
/**
 * Provides the base implementation for the vcms c a relation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsCARelationLocalServiceImpl}.
 * </p>
 *
...
public abstract class VcmsCARelationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsCARelationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsCARelationLocalServiceUtil} to access the vcms c a relation local service.
	 */
	...
	public VcmsCARelation addVcmsCARelation(VcmsCARelation vcmsCARelation) {
		...
		return vcmsCARelationPersistence.update(vcmsCARelation);
	}
	...
	public VcmsCARelation deleteVcmsCARelation(
		...
		return vcmsCARelationPersistence.remove(vcmsCARelationPK);
	}
	...
	public VcmsCARelation deleteVcmsCARelation(VcmsCARelation vcmsCARelation) {
		return vcmsCARelationPersistence.remove(vcmsCARelation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsCARelation.class,
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsCARelationLocalService.deleteVcmsCARelation((VcmsCARelation)persistedModel);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsCARelation",
			vcmsCARelationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsCARelation");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsCARelationLocalService.class.getName();
	}
