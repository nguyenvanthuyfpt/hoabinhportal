...
/**
 * Provides the base implementation for the adv type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.AdvTypeLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class AdvTypeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AdvTypeLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.AdvTypeLocalServiceUtil} to access the adv type local service.
	 */
	...
	@Override
	public AdvType addAdvType(AdvType advType) {
		advType.setNew(true);

		return advTypePersistence.update(advType);
	}
	...
	@Override
	public AdvType deleteAdvType(long typeId) throws PortalException {
		return advTypePersistence.remove(typeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AdvType deleteAdvType(AdvType advType) {
		return advTypePersistence.remove(advType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AdvType.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return advTypePersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public AdvType fetchAdvType(long typeId) {
		return advTypePersistence.fetchByPrimaryKey(typeId);
	}
	 ...
	 */
	@Override
	public AdvType getAdvType(long typeId) throws PortalException {
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(advTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AdvType.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(advTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AdvType.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return advTypeLocalService.deleteAdvType((AdvType)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return advTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AdvType updateAdvType(AdvType advType) {
		return advTypePersistence.update(advType);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.AdvType",
			advTypeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.AdvType");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AdvTypeLocalService.class.getName();
	}
