...
/**
 * Provides the base implementation for the vcms type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsTypeLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VcmsTypeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VcmsTypeLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsTypeLocalServiceUtil} to access the vcms type local service.
	 */
	...
	@Override
	public VcmsType addVcmsType(VcmsType vcmsType) {
		vcmsType.setNew(true);

		return vcmsTypePersistence.update(vcmsType);
	}
	 ...
	 */
	@Override
	public VcmsType createVcmsType(long typeId) {
	...
	@Override
	public VcmsType deleteVcmsType(long typeId) throws PortalException {
		return vcmsTypePersistence.remove(typeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VcmsType deleteVcmsType(VcmsType vcmsType) {
		return vcmsTypePersistence.remove(vcmsType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsType.class,
	...
	@Override
	public VcmsType fetchVcmsType(long typeId) {
	 ...
	 */
	@Override
	public VcmsType getVcmsType(long typeId) throws PortalException {
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vcmsTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VcmsType.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vcmsTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VcmsType.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsTypeLocalService.deleteVcmsType((VcmsType)persistedModel);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VcmsType updateVcmsType(VcmsType vcmsType) {
		return vcmsTypePersistence.update(vcmsType);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsType",
			vcmsTypeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsType");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsTypeLocalService.class.getName();
	}
