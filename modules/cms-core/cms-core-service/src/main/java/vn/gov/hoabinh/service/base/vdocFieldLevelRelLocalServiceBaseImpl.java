...
import vn.gov.hoabinh.service.vdocFieldLevelRelLocalService;
...
/**
 * Provides the base implementation for the vdoc field level rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.vdocFieldLevelRelLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class vdocFieldLevelRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements vdocFieldLevelRelLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.vdocFieldLevelRelLocalServiceUtil} to access the vdoc field level rel local service.
	 */
	...
	public vdocFieldLevelRel addvdocFieldLevelRel(
		...
		return vdocFieldLevelRelPersistence.update(vdocFieldLevelRel);
	}
	...
	public vdocFieldLevelRel createvdocFieldLevelRel(
		...
		return vdocFieldLevelRelPersistence.create(vdocFieldLevelRelPK);
	}
	...
	public vdocFieldLevelRel deletevdocFieldLevelRel(
		...
		return vdocFieldLevelRelPersistence.remove(vdocFieldLevelRelPK);
	}
	...
	public vdocFieldLevelRel deletevdocFieldLevelRel(
		vdocFieldLevelRel vdocFieldLevelRel) {
		return vdocFieldLevelRelPersistence.remove(vdocFieldLevelRel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(vdocFieldLevelRel.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vdocFieldLevelRelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vdocFieldLevelRelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public vdocFieldLevelRel fetchvdocFieldLevelRel(
		vdocFieldLevelRelPK vdocFieldLevelRelPK) {
		return vdocFieldLevelRelPersistence.fetchByPrimaryKey(vdocFieldLevelRelPK);
	}
	...
	public vdocFieldLevelRel getvdocFieldLevelRel(
		vdocFieldLevelRelPK vdocFieldLevelRelPK) throws PortalException {
		return vdocFieldLevelRelPersistence.findByPrimaryKey(vdocFieldLevelRelPK);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vdocFieldLevelRelLocalService.deletevdocFieldLevelRel((vdocFieldLevelRel)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vdocFieldLevelRelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<vdocFieldLevelRel> getvdocFieldLevelRels(int start, int end) {
		return vdocFieldLevelRelPersistence.findAll(start, end);
	}
	...
	public int getvdocFieldLevelRelsCount() {
		return vdocFieldLevelRelPersistence.countAll();
	}
	 ...
	 */
	public vdocFieldLevelRelLocalService getvdocFieldLevelRelLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.vdocFieldLevelRel",
			vdocFieldLevelRelLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.vdocFieldLevelRel");
	}
	...
	public String getOSGiServiceIdentifier() {
		return vdocFieldLevelRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vdocFieldLevelRelPersistence.getDataSource();
	...
	@BeanReference(type = vdocFieldLevelRelLocalService.class)
	protected vdocFieldLevelRelLocalService vdocFieldLevelRelLocalService;
