...
/**
 * Provides the base implementation for the vdoc document local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.vdocDocumentLocalServiceImpl}.
 * </p>
 *
...
public abstract class vdocDocumentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements vdocDocumentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.vdocDocumentLocalServiceUtil} to access the vdoc document local service.
	 */
	...
	public vdocDocument addvdocDocument(vdocDocument vdocDocument) {
		...
		return vdocDocumentPersistence.update(vdocDocument);
	}
	...
	@Override
	public vdocDocument deletevdocDocument(String docId)
		throws PortalException {
		return vdocDocumentPersistence.remove(docId);
	}
	...
	public vdocDocument deletevdocDocument(vdocDocument vdocDocument) {
		return vdocDocumentPersistence.remove(vdocDocument);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(vdocDocument.class,
	...
	@Override
	public vdocDocument fetchvdocDocument(String docId) {
		return vdocDocumentPersistence.fetchByPrimaryKey(docId);
	}
	 ...
	 */
	@Override
	public vdocDocument getvdocDocument(String docId) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vdocDocumentLocalService.deletevdocDocument((vdocDocument)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vdocDocumentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.vdocDocument",
			vdocDocumentLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.vdocDocument");
	}
	...
	public String getOSGiServiceIdentifier() {
		return vdocDocumentLocalService.class.getName();
	}
