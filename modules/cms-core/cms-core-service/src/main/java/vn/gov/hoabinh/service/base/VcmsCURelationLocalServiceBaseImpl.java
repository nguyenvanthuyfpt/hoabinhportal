...
import vn.gov.hoabinh.service.VcmsCURelationLocalService;
...
/**
 * Provides the base implementation for the vcms c u relation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VcmsCURelationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see vn.gov.hoabinh.service.impl.VcmsCURelationLocalServiceImpl
 * @see vn.gov.hoabinh.service.VcmsCURelationLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VcmsCURelationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VcmsCURelationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VcmsCURelationLocalServiceUtil} to access the vcms c u relation local service.
	 */
	...
	@Override
	public VcmsCURelation addVcmsCURelation(VcmsCURelation vcmsCURelation) {
		vcmsCURelation.setNew(true);

		return vcmsCURelationPersistence.update(vcmsCURelation);
	}
	 ...
	 */
	@Override
	public VcmsCURelation createVcmsCURelation(
		VcmsCURelationPK vcmsCURelationPK) {
		return vcmsCURelationPersistence.create(vcmsCURelationPK);
	}
	...
	@Override
	public VcmsCURelation deleteVcmsCURelation(
		VcmsCURelationPK vcmsCURelationPK) throws PortalException {
		return vcmsCURelationPersistence.remove(vcmsCURelationPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VcmsCURelation deleteVcmsCURelation(VcmsCURelation vcmsCURelation) {
		return vcmsCURelationPersistence.remove(vcmsCURelation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VcmsCURelation.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vcmsCURelationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vcmsCURelationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VcmsCURelation fetchVcmsCURelation(VcmsCURelationPK vcmsCURelationPK) {
		return vcmsCURelationPersistence.fetchByPrimaryKey(vcmsCURelationPK);
	}
	 ...
	 */
	@Override
	public VcmsCURelation getVcmsCURelation(VcmsCURelationPK vcmsCURelationPK)
		throws PortalException {
		return vcmsCURelationPersistence.findByPrimaryKey(vcmsCURelationPK);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vcmsCURelationLocalService.deleteVcmsCURelation((VcmsCURelation)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vcmsCURelationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VcmsCURelation> getVcmsCURelations(int start, int end) {
		return vcmsCURelationPersistence.findAll(start, end);
	}
	...
	public int getVcmsCURelationsCount() {
		return vcmsCURelationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VcmsCURelation updateVcmsCURelation(VcmsCURelation vcmsCURelation) {
		return vcmsCURelationPersistence.update(vcmsCURelation);
	}
	 ...
	 */
	public VcmsCURelationLocalService getVcmsCURelationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VcmsCURelation",
			vcmsCURelationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VcmsCURelation");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VcmsCURelationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vcmsCURelationPersistence.getDataSource();
	...
	@BeanReference(type = VcmsCURelationLocalService.class)
	protected VcmsCURelationLocalService vcmsCURelationLocalService;
