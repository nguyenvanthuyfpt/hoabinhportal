...
/**
 * Provides the base implementation for the v contact local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VContactLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VContactLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VContactLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VContactLocalServiceUtil} to access the v contact local service.
	 */
	...
	public VContact addVContact(VContact vContact) {
		...
		return vContactPersistence.update(vContact);
	}
	...
	public VContact createVContact(long id) {
		return vContactPersistence.create(id);
	}
	...
	public VContact deleteVContact(long id) throws PortalException {
		return vContactPersistence.remove(id);
	}
	...
	public VContact deleteVContact(VContact vContact) {
		return vContactPersistence.remove(vContact);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VContact.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vContactPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return vContactPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vContactPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VContact getVContact(long id) throws PortalException {
		return vContactPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vContactLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VContact.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vContactLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VContact.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vContactLocalService.deleteVContact((VContact)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vContactPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VContact> getVContacts(int start, int end) {
		return vContactPersistence.findAll(start, end);
	}
	...
	public int getVContactsCount() {
		return vContactPersistence.countAll();
	}
	 ...
	 */
	public VContactLocalService getVContactLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VContact",
			vContactLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VContact");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VContactLocalService.class.getName();
	}
	...
	@BeanReference(type = VContactLocalService.class)
	protected VContactLocalService vContactLocalService;
