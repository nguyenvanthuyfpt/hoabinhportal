...
/**
 * Provides the base implementation for the v legal draft document local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gov.hoabinh.service.impl.VLegalDraftDocumentLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class VLegalDraftDocumentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VLegalDraftDocumentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gov.hoabinh.service.VLegalDraftDocumentLocalServiceUtil} to access the v legal draft document local service.
	 */
	...
	public VLegalDraftDocument addVLegalDraftDocument(
		...
		return vLegalDraftDocumentPersistence.update(vLegalDraftDocument);
	}
	 ...
	 */
	@Override
	public VLegalDraftDocument createVLegalDraftDocument(String draftId) {
		return vLegalDraftDocumentPersistence.create(draftId);
	}
	...
	@Override
	public VLegalDraftDocument deleteVLegalDraftDocument(String draftId)
		throws PortalException {
		return vLegalDraftDocumentPersistence.remove(draftId);
	}
	...
	public VLegalDraftDocument deleteVLegalDraftDocument(
		VLegalDraftDocument vLegalDraftDocument) {
		return vLegalDraftDocumentPersistence.remove(vLegalDraftDocument);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VLegalDraftDocument.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vLegalDraftDocumentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vLegalDraftDocumentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VLegalDraftDocument fetchVLegalDraftDocument(String draftId) {
		return vLegalDraftDocumentPersistence.fetchByPrimaryKey(draftId);
	}
	 ...
	 */
	@Override
	public VLegalDraftDocument getVLegalDraftDocument(String draftId)
		throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vLegalDraftDocumentLocalService.deleteVLegalDraftDocument((VLegalDraftDocument)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vLegalDraftDocumentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VLegalDraftDocument> getVLegalDraftDocuments(int start, int end) {
		return vLegalDraftDocumentPersistence.findAll(start, end);
	}
	...
	public int getVLegalDraftDocumentsCount() {
		return vLegalDraftDocumentPersistence.countAll();
	}
	 ...
	 */
	public VLegalDraftDocumentLocalService getVLegalDraftDocumentLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("vn.gov.hoabinh.model.VLegalDraftDocument",
			vLegalDraftDocumentLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"vn.gov.hoabinh.model.VLegalDraftDocument");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VLegalDraftDocumentLocalService.class.getName();
	}
	...
	@BeanReference(type = VLegalDraftDocumentLocalService.class)
	protected VLegalDraftDocumentLocalService vLegalDraftDocumentLocalService;
