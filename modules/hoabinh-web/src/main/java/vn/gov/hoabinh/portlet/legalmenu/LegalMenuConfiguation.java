...
@Component(configurationPid = "vn.gov.hoabinh.configuration.LegalMenuConfig", 
	...
	immediate = true, 
	property = {
		"javax.portlet.name=vn_gov_hoabinh_portlet_legalmenu_LegalMenuPortlet"
	}, 
	service = ConfigurationAction.class)
public class LegalMenuConfiguation extends DefaultConfigurationAction {
	...
	private static final Log _log = LogFactoryUtil.getLog(LegalMenuConfiguation.class);
