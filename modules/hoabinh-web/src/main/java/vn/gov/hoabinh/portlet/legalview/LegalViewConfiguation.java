...
public class LegalViewConfiguation extends DefaultConfigurationAction {

	@Override
	public void include(PortletConfig portletConfig, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		// TODO Auto-generated method stub
		request.setAttribute(LegalViewConfig.class.getName(), _configuration);
	...
	private static final Log _log = LogFactoryUtil.getLog(LegalViewConfiguation.class);
