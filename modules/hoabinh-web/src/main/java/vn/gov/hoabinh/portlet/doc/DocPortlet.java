...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Doc Portlet",
		"javax.portlet.name=vn_gov_hoabinh_doc",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/doc/view.jsp",
...
public class DocPortlet extends MVCPortlet {
