...
<%@page import="vn.gov.hoabinh.configuration.FaqMenuConfig"%>
...
<%
	FaqMenuConfig configuration = (FaqMenuConfig)renderRequest.getAttribute(FaqMenuConfig.class.getName());
	...
	if (Validator.isNotNull(configuration)) {
		...
		categorySelected = portletPreferences.getValue("categorySel", configuration.categorySel());
	} else {
		...
		categorySelected = portletPreferences.getValue("categorySel", "");
	}
