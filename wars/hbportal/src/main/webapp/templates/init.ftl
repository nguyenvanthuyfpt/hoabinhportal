...
/>
<#list roles as role>
      <#if role.getName() == "PheDuyet" || role.getName() == "CanBoXacMinh" || role.getName() == "XacMinh&PheDuyet">
      		<#assign has_redirect = "false" />
            <#break>
    </#if>             
</#list>

<#if current_url?contains("com_liferay_login_web_portlet_LoginPortlet") && has_redirect?contains("true")>
	<#assign check_url = "true" />
<#else>
	<#assign check_url = "false" />
</#if>

<#if current_url?contains("english")>
...
<#assign
	...
	cur_datetime = current_time?date?string("dd/MM/yyyy")
	cur_day = current_time?date?string("EEE")
/>

<#switch cur_day>
  <#case "Mon">
     <#assign day_text = "Thứ 2" />
     <#assign day_text_en = "Mon" />
     <#break>
  <#case "Tue">
     <#assign day_text = "Thứ 3" />
     <#assign day_text_en = "Tue" />
     <#break>
  <#case "Wed">
     <#assign day_text = "Thứ 4" />
     <#assign day_text_en = "Web" />
     <#break>
  <#case "Thu">
     <#assign day_text = "Thứ 5" />
     <#assign day_text_en = "Thu" />
     <#break>   
  <#case "Fri">
     <#assign day_text = "Thứ 6" />
     <#assign day_text_en = "Fri" />
     <#break>
  <#case "Sat">
     <#assign day_text = "Thứ 7" />
     <#assign day_text_en = "Sat" />
     <#break>
  <#default>
     <#assign day_text = "Chủ nhật" />
     <#assign day_text_en = "Sun" />
</#switch>

<#-- Custom banner -->
<#switch group_id>
  <#case 755339>
     <#assign banner_img = "sub/bcqh.jpg" 
     		layout_id = 803303
     />
     <#break>
  <#case 755288>
     <#assign banner_img = "sub/cctp.jpg" 
     		layout_id = 803303
     />
     <#break>
  <#case 755362>
     <#assign banner_img = "sub/lehoicaycomui.jpg" 
     		layout_id = 803303
     />
     <#break>
  <#case 755385>
     <#assign banner_img = "sub/camcaophong.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755408>
     <#assign banner_img = "sub/dhcdt.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755431>
     <#assign banner_img = "sub/chukyso.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755454>
     <#assign banner_img = "sub/dhdb.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755477>
     <#assign banner_img = "sub/ntvt.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755500>
     <#assign banner_img = "sub/tthcm.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755523>
     <#assign banner_img = "sub/hndhtt.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755546>
     <#assign banner_img = "sub/kyniem125.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755569>
     <#assign banner_img = "sub/kyniem130.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755592>
     <#assign banner_img = "sub/blgd.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755615>
     <#assign banner_img = "sub/sohoatruyenhinh.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 751988>
     <#assign banner_img = "sub/sothongtin.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755638>
     <#assign banner_img = "sub/thanhtra.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755661>
     <#assign banner_img = "sub/ttqh.jpg" 
     		layout_id = 803303
     />
     <#break>
   <#case 755684>
     <#assign banner_img = "sub/mail.jpg" 
     		layout_id = 803303
     />
     <#break>
  <#default>
     <#assign banner_img = "banner.jpg" 
     		layout_id = 803303
     />
</#switch>
...
<#-- ---------- Custom init ---------- -->
<#assign
	vi_sitemap_text = "Sơ đồ trang"
	vi_link_text = "Liên kết"
	vi_share_text = "Chia sẻ"
	vi_faq_text = "Hỏi đáp"
	
	en_sitemap_text = "Sitemap"
	en_link_text = "Links"
	en_share_text = "Share"
	en_faq_text = "FAQ"
	
	en_text = languageUtil.get(locale, "english")
	vi_text = languageUtil.get(locale, "vietnamese")
	home_page = "Home"
/>

<#include "${full_templates_path}/init_custom.ftl" />

<#assign searchURL = portletURLFactory.create(request,"vn_gov_hoabinh_portlet_search_SearchPortlet",layout_id,"ACTION_PHASE") />
${searchURL.setParameter("p_p_state", "maximized")}
${searchURL.setParameter("p_p_mode", "view")}
${searchURL.setParameter("search", "true")}